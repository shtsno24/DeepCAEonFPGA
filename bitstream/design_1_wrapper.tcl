...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net network_0_output_data [get_bd_intf_pins axi_dma_1/S_AXIS_S2MM] [get_bd_intf_pins network_0/output_data]
