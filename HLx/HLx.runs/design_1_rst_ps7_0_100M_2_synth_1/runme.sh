...
HD_PWD='/home/masudalab/DeepCAEonFPGA/DeepCAEonFPGA/HLx/HLx.runs/design_1_rst_ps7_0_100M_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_rst_ps7_0_100M_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_rst_ps7_0_100M_2.tcl
