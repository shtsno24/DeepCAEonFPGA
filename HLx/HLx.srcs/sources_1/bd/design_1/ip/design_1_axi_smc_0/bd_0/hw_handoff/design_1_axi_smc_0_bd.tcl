...
################################################################
# This is a generated script based on design: bd_afc3
#
...
proc create_hier_cell_s01_entry_pipeline { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.SEG001_BASE_ADDR {0x00000000FC000000} \
  ...
  set_property -dict [ list \
   ...
   CONFIG.RDATA_WIDTH {32} \
   CONFIG.READ_WRITE_MODE {WRITE_ONLY} \
   CONFIG.SEP000_PROTOCOL {AXI3} \
   CONFIG.SEP000_RDATA_WIDTH {64} \
   CONFIG.SEP000_WDATA_WIDTH {64} \
   CONFIG.SEP001_PROTOCOL {AXI3} \
   CONFIG.SEP001_RDATA_WIDTH {64} \
   CONFIG.SEP001_WDATA_WIDTH {64} \
   CONFIG.SUPPORTS_NARROW {0} \
...
proc create_hier_cell_clk_map { parentCell nameHier } {
  ...
  # Create port connections
  connect_bd_net -net clk_map_aclk_net [get_bd_pins M00_ACLK] [get_bd_pins S00_ACLK] [get_bd_pins S01_ACLK] [get_bd_pins aclk] [get_bd_pins swbd_aclk] [get_bd_pins psr_aclk/slowest_sync_clk]
  ...
  connect_bd_net -net psr_aclk_interconnect_aresetn [get_bd_pins M00_ARESETN] [get_bd_pins S00_ARESETN] [get_bd_pins S01_ARESETN] [get_bd_pins swbd_aresetn] [get_bd_pins psr_aclk/interconnect_aresetn]
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net swbd_aclk_net [get_bd_pins clk_map/swbd_aclk] [get_bd_pins m00_nodes/s_axi_aclk] [get_bd_pins s00_nodes/m_sc_clk] [get_bd_pins s01_nodes/m_sc_clk] [get_bd_pins switchboards/aclk]
  connect_bd_net -net swbd_aresetn_net [get_bd_pins clk_map/swbd_aresetn] [get_bd_pins m00_nodes/s_axi_aresetn] [get_bd_pins s00_nodes/m_sc_resetn] [get_bd_pins s01_nodes/m_sc_resetn] [get_bd_pins switchboards/aresetn]
