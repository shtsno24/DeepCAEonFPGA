...
(* CORE_GENERATION_INFO="network,hls_ip_2018_3,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=6.508000,HLS_SYN_LAT=3142,HLS_SYN_TPT=none,HLS_SYN_MEM=17,HLS_SYN_DSP=0,HLS_SYN_FF=230,HLS_SYN_LUT=578,HLS_VERSION=2018_3}" *)
...
reg   [0:0] tmp_6_reg_305_pp0_iter1_reg;
reg   [9:0] i2_reg_199;
...
reg   [63:0] tmp_4_reg_295;
wire   [0:0] tmp_6_fu_249_p2;
...
wire   [9:0] i_3_fu_255_p2;
reg    ap_enable_reg_pp0_iter0;
wire   [0:0] tmp_user_V_fu_266_p2;
reg   [0:0] tmp_user_V_reg_314;
wire   [0:0] tmp_last_V_fu_272_p2;
...
wire   [63:0] tmp_1_fu_227_p1;
wire   [63:0] i2_cast1_fu_261_p1;
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ...
        if (((1'b0 == ap_block_pp0_stage0_subdone) & (1'b1 == ap_condition_pp0_exit_iter0_state5) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            ap_enable_reg_pp0_iter0 <= 1'b0;
        end else if (((tmp_3_fu_232_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (posedge ap_clk) begin
    if ((~((exitcond_fu_210_p2 == 1'd0) & (input_data_V_data_V_0_vld_out == 1'b0)) & (exitcond_fu_210_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        i1_reg_188 <= 10'd0;
...
always @ (posedge ap_clk) begin
    if (((tmp_3_fu_232_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
        i2_reg_199 <= 10'd0;
    end else if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_6_fu_249_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        i2_reg_199 <= i_3_fu_255_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((~((exitcond_fu_210_p2 == 1'd0) & (input_data_V_data_V_0_vld_out == 1'b0)) & (exitcond_fu_210_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (posedge ap_clk) begin
    if (((tmp_3_fu_232_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
        tmp_4_reg_295[9 : 0] <= tmp_4_fu_244_p1[9 : 0];
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_6_fu_249_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        MemBank_B_address0 = tmp_4_fu_244_p1;
    end else if ((1'b1 == ap_CS_fsm_state2)) begin
        MemBank_B_address0 = tmp_1_fu_227_p1;
    end else begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state3) | (~((exitcond_fu_210_p2 == 1'd0) & (input_data_V_data_V_0_vld_out == 1'b0)) & (1'b1 == ap_CS_fsm_state2)))) begin
        MemBank_B_ce0 = 1'b1;
    end else begin
        MemBank_B_ce0 = 1'b0;
    end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        MemBank_Out_address0 = i2_cast1_fu_261_p1;
    end else if ((1'b1 == ap_CS_fsm_state4)) begin
        MemBank_Out_address0 = tmp_4_reg_295;
    end else begin
...
always @ (*) begin
    if (((exitcond_fu_210_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    if ((((1'b0 == ap_block_pp0_stage0) & (tmp_6_reg_305_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((1'b0 == ap_block_pp0_stage0) & (tmp_6_reg_305 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_6_reg_305 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            ...
            end else if ((~((exitcond_fu_210_p2 == 1'd0) & (input_data_V_data_V_0_vld_out == 1'b0)) & (exitcond_fu_210_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (tmp_6_fu_249_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1)) & ~((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (tmp_6_fu_249_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1)) | ((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)))) begin
...
always @ (*) begin
    ap_block_state2 = ((exitcond_fu_210_p2 == 1'd0) & (input_data_V_data_V_0_vld_out == 1'b0));
end

assign ap_block_state5_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state6_io = ((tmp_6_reg_305 == 1'd0) & (output_data_V_data_V_1_ack_in == 1'b0));
end

assign ap_block_state6_pp0_stage0_iter1 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state7_io = ((tmp_6_reg_305_pp0_iter1_reg == 1'd0) & (output_data_V_data_V_1_ack_in == 1'b0));
end
...
assign exitcond_fu_210_p2 = ((i_reg_177 == 10'd784) ? 1'b1 : 1'b0);

assign i2_cast1_fu_261_p1 = i2_reg_199;

assign i_1_fu_216_p2 = (i_reg_177 + 10'd1);

assign i_2_fu_238_p2 = (i1_reg_188 + 10'd1);

assign i_3_fu_255_p2 = (i2_reg_199 + 10'd1);
...
assign tmp_1_fu_227_p1 = i_reg_177;

assign tmp_3_fu_232_p2 = ((i1_reg_188 == 10'd784) ? 1'b1 : 1'b0);

assign tmp_4_fu_244_p1 = i1_reg_188;

assign tmp_6_fu_249_p2 = ((i2_reg_199 == 10'd784) ? 1'b1 : 1'b0);

assign tmp_last_V_fu_272_p2 = ((i2_reg_199 == 10'd783) ? 1'b1 : 1'b0);

assign tmp_user_V_fu_266_p2 = ((i2_reg_199 == 10'd0) ? 1'b1 : 1'b0);

always @ (posedge ap_clk) begin
    tmp_4_reg_295[63:10] <= 54'b000000000000000000000000000000000000000000000000000000;
end
