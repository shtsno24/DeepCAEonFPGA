...
wire  signed [31:0] tmp_57_fu_329_p2;
reg  signed [31:0] tmp_57_reg_582;
...
reg   [13:0] output_addr_18_reg_605;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state5)) begin
        output_addr_18_reg_605 <= tmp_45_fu_390_p1;
...
assign tmp_33_fu_386_p2 = ($signed({{1'b0}, {tmp_33_fu_386_p0}}) * $signed(tmp_57_reg_582));
...
assign tmp_57_fu_329_p2 = ($signed(tmp_26_fu_299_p1) + $signed(phi_mul4_reg_136));
