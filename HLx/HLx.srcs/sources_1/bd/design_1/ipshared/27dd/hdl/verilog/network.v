...
(* CORE_GENERATION_INFO="network,hls_ip_2018_3_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=6.508000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=17,HLS_SYN_DSP=0,HLS_SYN_FF=258,HLS_SYN_LUT=624,HLS_VERSION=2018_3_1}" *)
...
reg   [0:0] tmp_4_reg_303_pp0_iter1_reg;
reg   [9:0] i_2_reg_199;
wire   [31:0] i_3_fu_224_p2;
wire   [0:0] tmp_fu_230_p2;
wire    ap_CS_fsm_state3;
wire   [9:0] i_4_fu_236_p2;
reg   [9:0] i_4_reg_288;
wire   [63:0] tmp_2_fu_242_p1;
reg   [63:0] tmp_2_reg_293;
...
wire   [9:0] i_5_fu_253_p2;
reg    ap_enable_reg_pp0_iter0;
wire   [0:0] tmp_user_V_fu_264_p2;
reg   [0:0] tmp_user_V_reg_317;
...
reg    MemBank_Out_ce0;
reg    MemBank_Out_we0;
reg  signed [31:0] i_reg_177;
wire   [0:0] tmp_last_V_fu_220_p1;
reg   [9:0] i_1_reg_188;
wire    ap_CS_fsm_state4;
wire  signed [63:0] tmp_1_fu_210_p1;
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ...
        if (((1'b0 == ap_block_pp0_stage0_subdone) & (1'b1 == ap_condition_pp0_exit_iter0_state5) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            ap_enable_reg_pp0_iter0 <= 1'b0;
        end else if (((tmp_fu_230_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ...
        if ((((input_data_data_V_0_state == 2'd2) & (input_data_data_V_0_vld_in == 1'b0)) | ((input_data_data_V_0_state == 2'd3) & (input_data_data_V_0_vld_in == 1'b0) & (input_data_data_V_0_ack_out == 1'b1)))) begin
        ...
        end else if (((~((input_data_data_V_0_vld_in == 1'b0) & (input_data_data_V_0_ack_out == 1'b1)) & ~((input_data_data_V_0_ack_out == 1'b0) & (input_data_data_V_0_vld_in == 1'b1)) & (input_data_data_V_0_state == 2'd3)) | ((input_data_data_V_0_state == 2'd1) & (input_data_data_V_0_ack_out == 1'b1)) | ((input_data_data_V_0_state == 2'd2) & (input_data_data_V_0_vld_in == 1'b1)))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ...
        end else if ((((output_data_dest_V_1_state == 2'd1) & (output_data_dest_V_1_ack_out == 1'b0)) | ((output_data_dest_V_1_state == 2'd3) & (output_data_dest_V_1_ack_out == 1'b0) & (output_data_dest_V_1_vld_in == 1'b1)))) begin
            output_data_dest_V_1_state <= 2'd1;
        end else if (((~((output_data_dest_V_1_vld_in == 1'b0) & (output_data_dest_V_1_ack_out == 1'b1)) & ~((output_data_dest_V_1_ack_out == 1'b0) & (output_data_dest_V_1_vld_in == 1'b1)) & (output_data_dest_V_1_state == 2'd3)) | ((output_data_dest_V_1_state == 2'd1) & (output_data_dest_V_1_ack_out == 1'b1)) | ((output_data_dest_V_1_state == 2'd2) & (output_data_dest_V_1_vld_in == 1'b1)))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ...
        end else if ((((output_data_id_V_1_state == 2'd1) & (output_data_id_V_1_ack_out == 1'b0)) | ((output_data_id_V_1_state == 2'd3) & (output_data_id_V_1_ack_out == 1'b0) & (output_data_id_V_1_vld_in == 1'b1)))) begin
            output_data_id_V_1_state <= 2'd1;
        end else if (((~((output_data_id_V_1_vld_in == 1'b0) & (output_data_id_V_1_ack_out == 1'b1)) & ~((output_data_id_V_1_ack_out == 1'b0) & (output_data_id_V_1_vld_in == 1'b1)) & (output_data_id_V_1_state == 2'd3)) | ((output_data_id_V_1_state == 2'd1) & (output_data_id_V_1_ack_out == 1'b1)) | ((output_data_id_V_1_state == 2'd2) & (output_data_id_V_1_vld_in == 1'b1)))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ...
        end else if ((((output_data_last_V_1_state == 2'd1) & (output_data_last_V_1_ack_out == 1'b0)) | ((output_data_last_V_1_state == 2'd3) & (output_data_last_V_1_ack_out == 1'b0) & (output_data_last_V_1_vld_in == 1'b1)))) begin
            output_data_last_V_1_state <= 2'd1;
        end else if (((~((output_data_last_V_1_vld_in == 1'b0) & (output_data_last_V_1_ack_out == 1'b1)) & ~((output_data_last_V_1_ack_out == 1'b0) & (output_data_last_V_1_vld_in == 1'b1)) & (output_data_last_V_1_state == 2'd3)) | ((output_data_last_V_1_state == 2'd1) & (output_data_last_V_1_ack_out == 1'b1)) | ((output_data_last_V_1_state == 2'd2) & (output_data_last_V_1_vld_in == 1'b1)))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ...
        end else if ((((output_data_strb_V_1_state == 2'd1) & (output_data_strb_V_1_ack_out == 1'b0)) | ((output_data_strb_V_1_state == 2'd3) & (output_data_strb_V_1_ack_out == 1'b0) & (output_data_strb_V_1_vld_in == 1'b1)))) begin
            output_data_strb_V_1_state <= 2'd1;
        end else if (((~((output_data_strb_V_1_vld_in == 1'b0) & (output_data_strb_V_1_ack_out == 1'b1)) & ~((output_data_strb_V_1_ack_out == 1'b0) & (output_data_strb_V_1_vld_in == 1'b1)) & (output_data_strb_V_1_state == 2'd3)) | ((output_data_strb_V_1_state == 2'd1) & (output_data_strb_V_1_ack_out == 1'b1)) | ((output_data_strb_V_1_state == 2'd2) & (output_data_strb_V_1_vld_in == 1'b1)))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ...
        end else if ((((output_data_user_V_1_state == 2'd1) & (output_data_user_V_1_ack_out == 1'b0)) | ((output_data_user_V_1_state == 2'd3) & (output_data_user_V_1_ack_out == 1'b0) & (output_data_user_V_1_vld_in == 1'b1)))) begin
            output_data_user_V_1_state <= 2'd1;
        end else if (((~((output_data_user_V_1_vld_in == 1'b0) & (output_data_user_V_1_ack_out == 1'b1)) & ~((output_data_user_V_1_ack_out == 1'b0) & (output_data_user_V_1_vld_in == 1'b1)) & (output_data_user_V_1_state == 2'd3)) | ((output_data_user_V_1_state == 2'd1) & (output_data_user_V_1_ack_out == 1'b1)) | ((output_data_user_V_1_state == 2'd2) & (output_data_user_V_1_vld_in == 1'b1)))) begin
...
always @ (posedge ap_clk) begin
    if (((tmp_last_V_fu_220_p1 == 1'd1) & (input_data_data_V_0_vld_out == 1'b1) & (1'b1 == ap_CS_fsm_state2))) begin
        i_1_reg_188 <= 10'd0;
...
always @ (posedge ap_clk) begin
    if (((tmp_fu_230_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
        i_2_reg_199 <= 10'd0;
    end else if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_4_fu_247_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        i_2_reg_199 <= i_5_fu_253_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((tmp_last_V_fu_220_p1 == 1'd0) & (input_data_data_V_0_vld_out == 1'b1) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (posedge ap_clk) begin
    if (((tmp_fu_230_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
        tmp_2_reg_293[9 : 0] <= tmp_2_fu_242_p1[9 : 0];
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_4_fu_247_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        MemBank_B_address0 = tmp_2_fu_242_p1;
    end else if ((1'b1 == ap_CS_fsm_state2)) begin
        MemBank_B_address0 = tmp_1_fu_210_p1;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        MemBank_Out_address0 = tmp_5_fu_259_p1;
    end else if ((1'b1 == ap_CS_fsm_state4)) begin
        MemBank_Out_address0 = tmp_2_reg_293;
    end else begin
...
always @ (*) begin
    if ((~((output_data_dest_V_1_ack_in == 1'b0) | (output_data_id_V_1_ack_in == 1'b0) | (output_data_last_V_1_ack_in == 1'b0) | (output_data_user_V_1_ack_in == 1'b0) | (output_data_strb_V_1_ack_in == 1'b0) | (output_data_keep_V_1_ack_in == 1'b0) | (output_data_data_V_1_ack_in == 1'b0)) & (output_data_dest_V_1_state[1'd0] == 1'b0) & (output_data_id_V_1_state[1'd0] == 1'b0) & (output_data_last_V_1_state[1'd0] == 1'b0) & (output_data_user_V_1_state[1'd0] == 1'b0) & (output_data_strb_V_1_state[1'd0] == 1'b0) & (output_data_keep_V_1_state[1'd0] == 1'b0) & (output_data_data_V_1_state[1'd0] == 1'b0) & (1'b1 == ap_CS_fsm_state9))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if ((((1'b0 == ap_block_pp0_stage0) & (tmp_4_reg_303_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((1'b0 == ap_block_pp0_stage0) & (tmp_4_reg_303 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_4_reg_303 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            ...
            end else if (((tmp_last_V_fu_220_p1 == 1'd0) & (input_data_data_V_0_vld_out == 1'b1) & (1'b1 == ap_CS_fsm_state2))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (tmp_4_fu_247_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1)) & ~((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (tmp_4_fu_247_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1)) | ((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)))) begin
...
always @ (*) begin
    ap_block_state6_io = ((tmp_4_reg_303 == 1'd0) & (output_data_data_V_1_ack_in == 1'b0));
end

assign ap_block_state6_pp0_stage0_iter1 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state7_io = ((tmp_4_reg_303_pp0_iter1_reg == 1'd0) & (output_data_data_V_1_ack_in == 1'b0));
end

assign ap_block_state7_pp0_stage0_iter2 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state9 = ((output_data_dest_V_1_ack_in == 1'b0) | (output_data_id_V_1_ack_in == 1'b0) | (output_data_last_V_1_ack_in == 1'b0) | (output_data_user_V_1_ack_in == 1'b0) | (output_data_strb_V_1_ack_in == 1'b0) | (output_data_keep_V_1_ack_in == 1'b0) | (output_data_data_V_1_ack_in == 1'b0));
end
...
assign i_3_fu_224_p2 = ($signed(i_reg_177) + $signed(32'd1));

assign i_4_fu_236_p2 = (i_1_reg_188 + 10'd1);

assign i_5_fu_253_p2 = (i_2_reg_199 + 10'd1);
...
assign tmp_1_fu_210_p1 = i_reg_177;

assign tmp_2_fu_242_p1 = i_1_reg_188;

assign tmp_4_fu_247_p2 = ((i_2_reg_199 == 10'd784) ? 1'b1 : 1'b0);

assign tmp_5_fu_259_p1 = i_2_reg_199;

assign tmp_7_fu_270_p2 = ((i_2_reg_199 == 10'd783) ? 1'b1 : 1'b0);

assign tmp_fu_230_p2 = ((i_1_reg_188 == 10'd784) ? 1'b1 : 1'b0);

assign tmp_last_V_fu_220_p1 = input_data_last_V_0_data_out;

assign tmp_user_V_fu_264_p2 = ((i_2_reg_199 == 10'd0) ? 1'b1 : 1'b0);

always @ (posedge ap_clk) begin
    tmp_2_reg_293[63:10] <= 54'b000000000000000000000000000000000000000000000000000000;
end
