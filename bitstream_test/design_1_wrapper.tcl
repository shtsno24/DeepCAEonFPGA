...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net axi_dma_mm2s_M_AXIS_MM2S [get_bd_intf_pins axi_dma_mm2s/M_AXIS_MM2S] [get_bd_intf_pins axi_dma_mm2s/S_AXIS_S2MM]
  ...
  connect_bd_intf_net -intf_net axi_dma_mm2s_M_AXI_S2MM [get_bd_intf_pins axi_dma_mm2s/M_AXI_S2MM] [get_bd_intf_pins axi_smc/S01_AXI]
  ...
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces axi_dma_mm2s/Data_S2MM] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_0_HP0_DDR_LOWOCM
