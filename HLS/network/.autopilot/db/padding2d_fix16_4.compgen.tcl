...
set id 29
set name network_mul_mul_16s_16s_16_1_1
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { MaxPooling2D_0_array_address0 { O 12 vector } MaxPooling2D_0_array_ce0 { O 1 bit } MaxPooling2D_0_array_q0 { I 16 vector } } \
} "
} else {
