...
set ID 86
set hasByteEnable 0
set MemName pointwise_conv2d_fix_4_SeparableConv2D_2_b_s
...
set TrueReset 0
set IsROM 1
set ROMData { "0010001001011" "0011111001101" "0010101110101" "1111101101110" "0001100000001" "0110001110111" "1111000011000" "1111010100010" }
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { SeparableConv2D_2_m_s_address0 { O 9 vector } SeparableConv2D_2_m_s_ce0 { O 1 bit } SeparableConv2D_2_m_s_q0 { I 16 vector } } \
} "
} else {
