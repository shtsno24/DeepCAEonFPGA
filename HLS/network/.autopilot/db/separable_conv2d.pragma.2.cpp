# 1 "layers_c/separable_conv2d.cpp"
# 1 "layers_c/separable_conv2d.cpp" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 155 "<built-in>" 3
# 1 "<command line>" 1
...
# 8 "<command line>" 2
# 1 "<built-in>" 2
# 1 "layers_c/separable_conv2d.cpp" 2
...
uint8_t relu);
# 3 "layers_c/separable_conv2d.cpp" 2
...
uint16_t kernel_height, uint16_t kernel_width, const float* kernel,
uint8_t relu);
# 4 "layers_c/separable_conv2d.cpp" 2
...
uint8_t relu);
# 5 "layers_c/separable_conv2d.cpp" 2
