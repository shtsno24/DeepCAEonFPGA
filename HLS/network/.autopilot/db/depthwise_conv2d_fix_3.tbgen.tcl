...
set C_modelArgList {
	...
	{ output_r int 16 regular {array 1568 { 2 3 } 1 1 }  }
...
set portList { 
	...
	{ output_r_address0 sc_out sc_lv 11 signal 5 } 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.network_mul_mul_16s_15s_30_1_1_U108", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	output_r { ap_memory {  { output_r_address0 mem_address 1 11 }  { output_r_ce0 mem_ce 1 1 }  { output_r_we0 mem_we 1 1 }  { output_r_d0 mem_din 1 16 }  { output_r_q0 mem_dout 0 16 } } }
