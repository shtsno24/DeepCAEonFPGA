# 1 "layers_c/depthwise_conv2d.cpp"
# 1 "layers_c/depthwise_conv2d.cpp" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 155 "<built-in>" 3
# 1 "<command line>" 1
...
# 8 "<command line>" 2
# 1 "<built-in>" 2
# 1 "layers_c/depthwise_conv2d.cpp" 2
...
# 2 "layers_c/depthwise_conv2d.cpp" 2
...
uint8_t relu);
# 3 "layers_c/depthwise_conv2d.cpp" 2
...
#pragma HLS ALLOCATION instances=mul limit=27 operation
#pragma HLS ALLOCATION instances=add limit=27 operation
