set moduleName padding2d_fix16_3
...
set C_modelName {padding2d_fix16.3}
...
set C_modelArgList {
	...
	{ MaxPooling2D_1_array int 16 regular {array 392 { 1 3 } 1 1 } {global 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "input_depth", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "MaxPooling2D_1_array", "interface" : "memory", "bitwidth" : 16, "direction" : "READONLY", "bitSlice":[{"low":0,"up":15,"cElement": [{"cName": "MaxPooling2D_1_array","cData": "short","bit_use": { "low": 0,"up": 15},"cArray": [{"low" : 0,"up" : 7,"step" : 1},{"low" : 0,"up" : 6,"step" : 1},{"low" : 0,"up" : 6,"step" : 1}]}]}], "extern" : 0} ]}
...
set portList { 
	...
	{ MaxPooling2D_1_array_address0 sc_out sc_lv 9 signal 4 } 
	{ MaxPooling2D_1_array_ce0 sc_out sc_logic 1 signal 4 } 
	{ MaxPooling2D_1_array_q0 sc_in sc_lv 16 signal 4 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	...
	MaxPooling2D_1_array { ap_memory {  { MaxPooling2D_1_array_address0 mem_address 1 9 }  { MaxPooling2D_1_array_ce0 mem_ce 1 1 }  { MaxPooling2D_1_array_q0 mem_dout 0 16 } } }
}
