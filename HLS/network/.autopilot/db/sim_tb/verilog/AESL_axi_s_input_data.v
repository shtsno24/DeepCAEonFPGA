...
`define TV_IN_input_data_TDATA "./c.network.autotvin_input_data_V_data_V.dat"
`define INGRESS_STATUS_input_data_TDATA "./stream_ingress_status_input_data_V_data_V.dat"
`define TV_IN_input_data_TKEEP "./c.network.autotvin_input_data_V_keep_V.dat"
`define INGRESS_STATUS_input_data_TKEEP "./stream_ingress_status_input_data_V_keep_V.dat"
`define TV_IN_input_data_TSTRB "./c.network.autotvin_input_data_V_strb_V.dat"
`define INGRESS_STATUS_input_data_TSTRB "./stream_ingress_status_input_data_V_strb_V.dat"
`define TV_IN_input_data_TUSER "./c.network.autotvin_input_data_V_user_V.dat"
`define INGRESS_STATUS_input_data_TUSER "./stream_ingress_status_input_data_V_user_V.dat"
`define TV_IN_input_data_TLAST "./c.network.autotvin_input_data_V_last_V.dat"
`define INGRESS_STATUS_input_data_TLAST "./stream_ingress_status_input_data_V_last_V.dat"
`define TV_IN_input_data_TID "./c.network.autotvin_input_data_V_id_V.dat"
`define INGRESS_STATUS_input_data_TID "./stream_ingress_status_input_data_V_id_V.dat"
`define TV_IN_input_data_TDEST "./c.network.autotvin_input_data_V_dest_V.dat"
`define INGRESS_STATUS_input_data_TDEST "./stream_ingress_status_input_data_V_dest_V.dat"
