...
set C_modelArgList {
	...
	{ output_r int 16 regular {array 4096 { 0 3 } 0 1 }  }
	{ MaxPooling2D_0_array int 16 regular {array 3136 { 1 3 } 1 1 } {global 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "input_depth", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "MaxPooling2D_0_array", "interface" : "memory", "bitwidth" : 16, "direction" : "READONLY", "bitSlice":[{"low":0,"up":15,"cElement": [{"cName": "MaxPooling2D_0_array","cData": "short","bit_use": { "low": 0,"up": 15},"cArray": [{"low" : 0,"up" : 15,"step" : 1},{"low" : 0,"up" : 13,"step" : 1},{"low" : 0,"up" : 13,"step" : 1}]}]}], "extern" : 0} ]}
...
set portList { 
	...
	{ output_r_address0 sc_out sc_lv 12 signal 3 } 
	{ output_r_ce0 sc_out sc_logic 1 signal 3 } 
	{ output_r_we0 sc_out sc_logic 1 signal 3 } 
	{ output_r_d0 sc_out sc_lv 16 signal 3 } 
	{ MaxPooling2D_0_array_address0 sc_out sc_lv 12 signal 4 } 
	{ MaxPooling2D_0_array_ce0 sc_out sc_logic 1 signal 4 } 
	{ MaxPooling2D_0_array_q0 sc_in sc_lv 16 signal 4 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.network_mul_mul_16s_16s_16_1_1_U29", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.network_mul_mul_16s_16s_16_1_1_U30", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	output_r { ap_memory {  { output_r_address0 mem_address 1 12 }  { output_r_ce0 mem_ce 1 1 }  { output_r_we0 mem_we 1 1 }  { output_r_d0 mem_din 1 16 } } }
	MaxPooling2D_0_array { ap_memory {  { MaxPooling2D_0_array_address0 mem_address 1 12 }  { MaxPooling2D_0_array_ce0 mem_ce 1 1 }  { MaxPooling2D_0_array_q0 mem_dout 0 16 } } }
}
