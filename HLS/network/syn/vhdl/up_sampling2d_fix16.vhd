...
architecture behav of up_sampling2d_fix16 is 
    ...
    signal tmp_13_fu_269_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_13_reg_372 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal tmp_11_fu_260_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_14_fu_274_p1 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal tmp_10_fu_255_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_12_fu_265_p1 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond_fu_230_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state5))) then
                tmp_13_reg_372 <= tmp_13_fu_269_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    SeparableConv2D_3_ar_address0 <= tmp_11_fu_260_p1(12 - 1 downto 0);

    SeparableConv2D_3_ar_ce0_assign_proc : process(ap_CS_fsm_state5)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state5)) then 
    ...
    UpSampling2D_1_array_address0 <= tmp_14_fu_274_p1(14 - 1 downto 0);

    UpSampling2D_1_array_ce0_assign_proc : process(ap_CS_fsm_state6)
    begin
    ...
    UpSampling2D_1_array_d0 <= SeparableConv2D_3_ar_q0;

    UpSampling2D_1_array_we0_assign_proc : process(ap_CS_fsm_state6)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state6)) then 
    ...
    tmp_10_fu_255_p2 <= std_logic_vector(unsigned(tmp_8_fu_251_p1) + unsigned(tmp1_reg_349));
        tmp_11_fu_260_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_10_fu_255_p2),64));

    tmp_12_fu_265_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(out_w_reg_133),32));
    tmp_13_fu_269_p2 <= std_logic_vector(unsigned(tmp_12_fu_265_p1) + unsigned(tmp3_reg_354));
        tmp_14_fu_274_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_13_reg_372),64));
