...
wire   [63:0] tmp_62_fu_339_p1;
wire   [63:0] tmp_66_fu_443_p1;
wire   [63:0] tmp_68_fu_467_p1;
wire   [15:0] tmp_71_fu_487_p2;
wire   [15:0] tmp_63_fu_493_p2;
wire  signed [6:0] input_width_cast_fu_218_p1;
wire   [3:0] tmp_27_fu_260_p1;
...
network_mul_mul_16s_16s_30_1_1 #(
    ...
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 30 ))
network_mul_mul_16s_16s_30_1_1_U24(
...
always @ (posedge ap_clk) begin
    if (((exitcond2_fu_319_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
        output_addr_reg_586 <= tmp_62_fu_339_p1;
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        tmp_70_reg_637 <= {{tmp_69_fu_500_p2[29:14]}};
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state9) | (1'b1 == ap_CS_fsm_state10) | (1'b1 == ap_CS_fsm_state8) | (1'b1 == ap_CS_fsm_state5))) begin
        ...
        output_r_address0 = tmp_62_fu_339_p1;
    end else begin
...
assign input_r_address0 = tmp_66_fu_443_p1;
...
assign kernel_0_address0 = tmp_68_fu_467_p1;
...
assign p_shl_fu_264_p3 = {{tmp_27_fu_260_p1}, {3'd0}};
...
assign tmp_114_cast_fu_378_p1 = $signed(tmp_64_fu_372_p2);

assign tmp_115_cast_fu_424_p1 = k_w_reg_207;

assign tmp_122_cast_fu_463_p1 = $signed(tmp_67_fu_458_p2);

assign tmp_27_fu_260_p1 = out_d_reg_136[3:0];

assign tmp_61_fu_334_p2 = (tmp1_reg_573 + tmp_109_cast_fu_330_p1);

assign tmp_62_fu_339_p1 = tmp_61_fu_334_p2;

assign tmp_63_fu_493_p2 = (output_r_q0 + bias_q0);

assign tmp_64_fu_372_p2 = (p_shl5_cast_fu_368_p1 - tmp_113_cast9_fu_356_p1);

assign tmp_65_fu_438_p2 = (tmp5_cast_fu_434_p1 + tmp3_reg_599);

assign tmp_66_fu_443_p1 = tmp_65_fu_438_p2;

assign tmp_67_fu_458_p2 = (tmp7_cast_fu_454_p1 + tmp6_reg_604);

assign tmp_68_fu_467_p1 = $unsigned(tmp_122_cast_fu_463_p1);

assign tmp_71_fu_487_p2 = (output_r_q0 + tmp_70_reg_637);
