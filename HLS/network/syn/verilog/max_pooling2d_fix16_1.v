...
module max_pooling2d_fix16_1 (
        ...
        output_height,
        output_width,
        SeparableConv2D_0_ar_address0,
        SeparableConv2D_0_ar_ce0,
        SeparableConv2D_0_ar_q0,
...
output  [13:0] SeparableConv2D_0_ar_address0;
output   SeparableConv2D_0_ar_ce0;
input  [15:0] SeparableConv2D_0_ar_q0;
...
wire   [31:0] tmp_99_fu_186_p1;
reg   [31:0] tmp_99_reg_407;
wire   [31:0] tmp_100_fu_190_p1;
reg   [31:0] tmp_100_reg_412;
wire   [31:0] tmp_101_fu_194_p1;
reg   [31:0] tmp_101_reg_417;
...
wire   [31:0] tmp_113_cast_fu_248_p1;
reg   [31:0] tmp_113_cast_reg_453;
...
wire   [31:0] tmp_116_cast_fu_279_p1;
reg   [31:0] tmp_116_cast_reg_471;
wire   [0:0] exitcond2_fu_256_p2;
reg   [11:0] MaxPooling2D_0_array_1_reg_476;
wire   [0:0] tmp_20_fu_293_p1;
reg   [0:0] tmp_20_reg_481;
...
wire   [31:0] tmp_109_fu_328_p2;
reg   [31:0] tmp_109_reg_504;
wire    ap_CS_fsm_state8;
wire   [1:0] in_w_1_fu_342_p2;
reg   [1:0] in_w_1_reg_513;
wire    ap_CS_fsm_state9;
wire   [0:0] tmp_110_fu_348_p2;
reg   [0:0] tmp_110_reg_518;
...
wire  signed [63:0] tmp_107_fu_288_p1;
wire  signed [63:0] tmp_117_fu_362_p1;
wire  signed [63:0] tmp_113_fu_376_p1;
wire   [0:0] tmp_114_fu_381_p2;
wire   [31:0] tmp_102_fu_230_p1;
wire   [16:0] tmp_103_fu_240_p3;
wire   [15:0] tmp1_fu_252_p0;
wire   [16:0] tmp_105_fu_271_p3;
wire   [31:0] tmp_104_fu_267_p1;
wire   [31:0] tmp_106_fu_283_p2;
wire   [31:0] tmp_108_fu_309_p1;
wire   [31:0] tmp4_fu_313_p2;
wire   [15:0] tmp3_fu_324_p1;
wire   [0:0] tmp_21_fu_332_p1;
wire   [31:0] tmp_115_fu_353_p1;
wire   [31:0] tmp_116_fu_357_p2;
wire   [31:0] tmp_111_fu_367_p1;
wire   [31:0] tmp_112_fu_371_p2;
reg   [9:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (((exitcond2_fu_256_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state5))) begin
        MaxPooling2D_0_array_1_reg_476 <= tmp_107_fu_288_p1;
        tmp_116_cast_reg_471[16 : 1] <= tmp_116_cast_fu_279_p1[16 : 1];
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        ...
        tmp_113_cast_reg_453[16 : 1] <= tmp_113_cast_fu_248_p1[16 : 1];
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
        tmp_100_reg_412[15 : 0] <= tmp_100_fu_190_p1[15 : 0];
        tmp_101_reg_417[15 : 0] <= tmp_101_fu_194_p1[15 : 0];
        tmp_99_reg_407[15 : 0] <= tmp_99_fu_186_p1[15 : 0];
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state9) | ((1'b1 == ap_CS_fsm_state10) & (tmp_114_fu_381_p2 == 1'd1) & (tmp_110_reg_518 == 1'd1)) | ((tmp_110_reg_518 == 1'd0) & (1'b1 == ap_CS_fsm_state10)))) begin
...
always @ (*) begin
    if ((((1'b1 == ap_CS_fsm_state10) & (tmp_114_fu_381_p2 == 1'd1) & (tmp_110_reg_518 == 1'd1)) | ((tmp_110_reg_518 == 1'd0) & (1'b1 == ap_CS_fsm_state10)))) begin
...
always @ (*) begin
    if (((exitcond_fu_336_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state9))) begin
        if ((tmp_110_fu_348_p2 == 1'd1)) begin
            SeparableConv2D_0_ar_address0 = tmp_113_fu_376_p1;
        end else if ((tmp_110_fu_348_p2 == 1'd0)) begin
            SeparableConv2D_0_ar_address0 = tmp_117_fu_362_p1;
        end else begin
...
always @ (*) begin
    if ((((exitcond_fu_336_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state9) & (tmp_110_fu_348_p2 == 1'd1)) | ((exitcond_fu_336_p2 == 1'd0) & (tmp_110_fu_348_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state9)))) begin
...
assign MaxPooling2D_0_array_d0 = SeparableConv2D_0_ar_q0;
...
assign next_mul3_fu_198_p2 = (phi_mul2_reg_125 + tmp_100_reg_412);
...
assign tmp1_fu_252_p0 = tmp_101_reg_417;

assign tmp1_fu_252_p2 = ($signed({{1'b0}, {tmp1_fu_252_p0}}) * $signed(tmp_reg_448));

assign tmp2_fu_319_p2 = (tmp4_fu_313_p2 + tmp_113_cast_reg_453);

assign tmp3_fu_324_p1 = tmp_99_reg_407;

assign tmp3_fu_324_p2 = ($signed(tmp2_reg_494) * $signed({{1'b0}, {tmp3_fu_324_p1}}));

assign tmp4_fu_313_p2 = (phi_mul_reg_113 + tmp_108_fu_309_p1);

assign tmp_100_fu_190_p1 = output_height;

assign tmp_101_fu_194_p1 = output_width;

assign tmp_102_fu_230_p1 = out_h_reg_137;

assign tmp_103_fu_240_p3 = {{out_h_reg_137}, {1'd0}};

assign tmp_104_fu_267_p1 = out_w_reg_149;

assign tmp_105_fu_271_p3 = {{out_w_reg_149}, {1'd0}};

assign tmp_106_fu_283_p2 = (tmp_104_fu_267_p1 + tmp1_reg_458);

assign tmp_107_fu_288_p1 = $signed(tmp_106_fu_283_p2);

assign tmp_108_fu_309_p1 = in_h_reg_160;

assign tmp_109_fu_328_p2 = (tmp3_reg_499 + tmp_116_cast_reg_471);

assign tmp_110_fu_348_p2 = (tmp_21_fu_332_p1 | tmp_20_reg_481);

assign tmp_111_fu_367_p1 = in_w_reg_171;

assign tmp_112_fu_371_p2 = (tmp_109_reg_504 + tmp_111_fu_367_p1);

assign tmp_113_cast_fu_248_p1 = tmp_103_fu_240_p3;

assign tmp_113_fu_376_p1 = $signed(tmp_112_fu_371_p2);

assign tmp_114_fu_381_p2 = (($signed(MaxPooling2D_0_array_q0) < $signed(SeparableConv2D_0_ar_q0)) ? 1'b1 : 1'b0);

assign tmp_115_fu_353_p1 = in_w_reg_171;

assign tmp_116_cast_fu_279_p1 = tmp_105_fu_271_p3;

assign tmp_116_fu_357_p2 = (tmp_109_reg_504 + tmp_115_fu_353_p1);

assign tmp_117_fu_362_p1 = $signed(tmp_116_fu_357_p2);

assign tmp_20_fu_293_p1 = in_h_reg_160[0:0];

assign tmp_21_fu_332_p1 = in_w_reg_171[0:0];

assign tmp_99_fu_186_p1 = input_width;

assign tmp_fu_234_p2 = (tmp_102_fu_230_p1 + phi_mul2_reg_125);

assign tmp_s_fu_182_p1 = input_height;

always @ (posedge ap_clk) begin
    tmp_s_reg_402[31:16] <= 16'b0000000000000000;
    tmp_99_reg_407[31:16] <= 16'b0000000000000000;
    tmp_100_reg_412[31:16] <= 16'b0000000000000000;
    tmp_101_reg_417[31:16] <= 16'b0000000000000000;
    tmp_113_cast_reg_453[0] <= 1'b0;
    tmp_113_cast_reg_453[31:17] <= 15'b000000000000000;
    tmp_116_cast_reg_471[0] <= 1'b0;
    tmp_116_cast_reg_471[31:17] <= 15'b000000000000000;
end
