...
max_pooling2d_fix16::max_pooling2d_fix16(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_tmp_17_fu_293_p1);
    sensitive << ( in_h_reg_160 );
    ...
    SC_METHOD(thread_tmp_96_fu_371_p2);
    sensitive << ( tmp_90_reg_504 );
    sensitive << ( tmp_92_fu_367_p1 );

    SC_METHOD(thread_tmp_97_fu_376_p1);
    sensitive << ( tmp_96_fu_371_p2 );
    ...
    sc_trace(mVcdFile, tmp_17_fu_293_p1, "tmp_17_fu_293_p1");
    sc_trace(mVcdFile, tmp_17_reg_481, "tmp_17_reg_481");
    ...
    sc_trace(mVcdFile, tmp_96_fu_371_p2, "tmp_96_fu_371_p2");
...
void max_pooling2d_fix16::thread_ap_clk_no_reset_() {
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state6.read())) {
        ...
        tmp_17_reg_481 = tmp_17_fu_293_p1.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state9.read())) {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state5.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, exitcond2_fu_256_p2.read()))) {
        output_addr_reg_476 =  (sc_lv<9>) (tmp_87_fu_288_p1.read());
...
void max_pooling2d_fix16::thread_tmp_17_fu_293_p1() {
    tmp_17_fu_293_p1 = in_h_reg_160.read().range(1-1, 0);
}

void max_pooling2d_fix16::thread_tmp_18_fu_332_p1() {
    tmp_18_fu_332_p1 = in_w_reg_171.read().range(1-1, 0);
}
...
void max_pooling2d_fix16::thread_tmp_90_fu_328_p2() {
    tmp_90_fu_328_p2 = (!tmp3_reg_499.read().is_01() || !tmp_85_cast_reg_471.read().is_01())? sc_lv<32>(): (sc_biguint<32>(tmp3_reg_499.read()) + sc_biguint<32>(tmp_85_cast_reg_471.read()));
}

void max_pooling2d_fix16::thread_tmp_91_fu_348_p2() {
    tmp_91_fu_348_p2 = (tmp_18_fu_332_p1.read() | tmp_17_reg_481.read());
}
...
void max_pooling2d_fix16::thread_tmp_94_fu_357_p2() {
    tmp_94_fu_357_p2 = (!tmp_90_reg_504.read().is_01() || !tmp_93_fu_353_p1.read().is_01())? sc_lv<32>(): (sc_biguint<32>(tmp_90_reg_504.read()) + sc_biguint<32>(tmp_93_fu_353_p1.read()));
}
...
void max_pooling2d_fix16::thread_tmp_96_fu_371_p2() {
    tmp_96_fu_371_p2 = (!tmp_90_reg_504.read().is_01() || !tmp_92_fu_367_p1.read().is_01())? sc_lv<32>(): (sc_biguint<32>(tmp_90_reg_504.read()) + sc_biguint<32>(tmp_92_fu_367_p1.read()));
}

void max_pooling2d_fix16::thread_tmp_97_fu_376_p1() {
    tmp_97_fu_376_p1 = esl_sext<64,32>(tmp_96_fu_371_p2.read());
}

void max_pooling2d_fix16::thread_tmp_98_fu_381_p2() {
    tmp_98_fu_381_p2 = (!output_r_q0.read().is_01() || !input_r_q0.read().is_01())? sc_lv<1>(): (sc_bigint<16>(output_r_q0.read()) < sc_bigint<16>(input_r_q0.read()));
}
