...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(pointwise_conv2d_fix_3_SeparableConv2D_3_b_s_ram) {
        ram[0] = "0b11110110001011";
        ram[1] = "0b00001010010111";
        ram[2] = "0b11111100110110";
        ram[3] = "0b11111100010100";
        ram[4] = "0b11100001111110";
        ram[5] = "0b01010110011111";
        ram[6] = "0b11101001001000";
        ram[7] = "0b00010111110001";
        ram[8] = "0b11110001100000";
        ram[9] = "0b11111111110101";
        ram[10] = "0b11110000110001";
        ram[11] = "0b11110111110000";
        ram[12] = "0b00000110010111";
        ram[13] = "0b11110010101000";
        ram[14] = "0b00001101111110";
        ram[15] = "0b11111001000010";
