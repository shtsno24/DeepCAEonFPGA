...
struct max_pooling2d_fix16 : public sc_module {
    ...
    sc_signal< sc_lv<9> > output_addr_reg_476;
    sc_signal< sc_lv<1> > tmp_17_fu_293_p1;
    sc_signal< sc_lv<1> > tmp_17_reg_481;
