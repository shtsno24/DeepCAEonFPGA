...
module depthwise_conv2d_fix (
        ...
        SeparableConv2D_3_m_s_we0,
        SeparableConv2D_3_m_s_d0,
...
output   SeparableConv2D_3_m_s_we0;
output  [15:0] SeparableConv2D_3_m_s_d0;
...
reg[15:0] SeparableConv2D_3_m_s_d0;
...
wire   [16:0] tmp_103_cast1_fu_235_p1;
reg   [16:0] tmp_103_cast1_reg_514;
...
wire   [16:0] tmp_107_cast_fu_272_p1;
reg   [16:0] tmp_107_cast_reg_537;
...
wire   [16:0] tmp_108_cast_fu_295_p1;
reg   [16:0] tmp_108_cast_reg_555;
wire   [0:0] exitcond2_fu_280_p2;
reg   [10:0] SeparableConv2D_3_m_1_reg_560;
...
reg  signed [15:0] Padding2D_3_array_lo_reg_606;
wire    ap_CS_fsm_state9;
reg  signed [14:0] SeparableConv2D_3_w_2_reg_611;
reg   [15:0] tmp_117_reg_616;
...
wire  signed [63:0] tmp_109_fu_304_p1;
wire  signed [63:0] tmp_112_fu_405_p1;
wire   [63:0] tmp_114_fu_428_p1;
wire   [15:0] tmp_118_fu_448_p2;
wire   [18:0] p_shl_fu_239_p3;
wire   [31:0] tmp_106_fu_262_p1;
wire   [15:0] tmp1_fu_276_p1;
wire   [31:0] tmp_107_fu_291_p1;
wire   [31:0] tmp_108_fu_299_p2;
wire   [3:0] p_shl1_fu_329_p3;
wire   [4:0] p_shl1_cast_fu_337_p1;
wire   [4:0] tmp_111_cast9_fu_325_p1;
wire   [4:0] tmp_110_fu_341_p2;
wire   [16:0] tmp_111_cast1_fu_321_p1;
wire   [16:0] tmp4_fu_351_p2;
wire   [31:0] tmp4_cast_fu_356_p1;
wire  signed [20:0] tmp_112_cast_fu_347_p1;
wire   [15:0] tmp3_fu_371_p0;
wire   [16:0] tmp_113_cast_fu_387_p1;
wire   [16:0] tmp5_fu_391_p2;
wire   [31:0] tmp5_cast_fu_396_p1;
wire   [31:0] tmp_111_fu_400_p2;
wire   [16:0] tmp7_fu_410_p2;
wire   [20:0] tmp7_cast_fu_415_p1;
wire   [20:0] tmp_113_fu_419_p2;
wire  signed [31:0] tmp_120_cast_fu_424_p1;
wire  signed [29:0] tmp_115_fu_454_p2;
reg   [10:0] ap_NS_fsm;
...
network_mul_mul_16s_15s_30_1_1 #(
    ...
    .din1_WIDTH( 15 ),
    .dout_WIDTH( 30 ))
network_mul_mul_16s_15s_30_1_1_U101(
...
always @ (posedge ap_clk) begin
    if (((exitcond2_fu_280_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state5))) begin
        SeparableConv2D_3_m_1_reg_560 <= tmp_109_fu_304_p1;
        tmp_108_cast_reg_555[15 : 0] <= tmp_108_cast_fu_295_p1[15 : 0];
    end
end
...
always @ (posedge ap_clk) begin
    if (((exitcond4_fu_224_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        ...
        tmp_103_cast1_reg_514[15 : 0] <= tmp_103_cast1_fu_235_p1[15 : 0];
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        ...
        tmp_107_cast_reg_537[15 : 0] <= tmp_107_cast_fu_272_p1[15 : 0];
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state10)) begin
        tmp_117_reg_616 <= {{tmp_115_fu_454_p2[29:14]}};
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state11) | (1'b1 == ap_CS_fsm_state10))) begin
        ...
        SeparableConv2D_3_m_s_address0 = tmp_109_fu_304_p1;
    end else begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state11)) begin
        ...
        SeparableConv2D_3_m_s_d0 = 16'd0;
    end else begin
        SeparableConv2D_3_m_s_d0 = 'bx;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state11) | ((exitcond2_fu_280_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state5)))) begin
        SeparableConv2D_3_m_s_we0 = 1'b1;
    end else begin
...
assign Padding2D_3_array_address0 = tmp_112_fu_405_p1;

assign SeparableConv2D_3_w_s_address0 = tmp_114_fu_428_p1;
...
assign p_shl1_cast_fu_337_p1 = p_shl1_fu_329_p3;

assign p_shl1_fu_329_p3 = {{k_h_reg_176}, {2'd0}};
...
assign tmp4_fu_351_p2 = (tmp_111_cast1_fu_321_p1 + tmp_107_cast_reg_537);

assign tmp5_cast_fu_396_p1 = tmp5_fu_391_p2;

assign tmp5_fu_391_p2 = (tmp_108_cast_reg_555 + tmp_113_cast_fu_387_p1);

assign tmp6_fu_366_p2 = ($signed(tmp_112_cast_fu_347_p1) + $signed(p_shl_cast_reg_519));

assign tmp7_cast_fu_415_p1 = tmp7_fu_410_p2;

assign tmp7_fu_410_p2 = (tmp_103_cast1_reg_514 + tmp_113_cast_fu_387_p1);
...
assign tmp_103_cast1_fu_235_p1 = out_d_reg_118;

assign tmp_106_fu_262_p1 = out_h_reg_153;

assign tmp_107_cast_fu_272_p1 = out_h_reg_153;

assign tmp_107_fu_291_p1 = out_w_reg_165;

assign tmp_108_cast_fu_295_p1 = out_w_reg_165;

assign tmp_108_fu_299_p2 = (tmp1_reg_542 + tmp_107_fu_291_p1);

assign tmp_109_fu_304_p1 = $signed(tmp_108_fu_299_p2);

assign tmp_110_fu_341_p2 = (p_shl1_cast_fu_337_p1 - tmp_111_cast9_fu_325_p1);

assign tmp_111_cast1_fu_321_p1 = k_h_reg_176;

assign tmp_111_cast9_fu_325_p1 = k_h_reg_176;

assign tmp_111_fu_400_p2 = (tmp5_cast_fu_396_p1 + tmp3_reg_583);

assign tmp_112_cast_fu_347_p1 = $signed(tmp_110_fu_341_p2);

assign tmp_112_fu_405_p1 = $signed(tmp_111_fu_400_p2);

assign tmp_113_cast_fu_387_p1 = k_w_reg_187;

assign tmp_113_fu_419_p2 = (tmp7_cast_fu_415_p1 + tmp6_reg_578);

assign tmp_114_fu_428_p1 = $unsigned(tmp_120_cast_fu_424_p1);

assign tmp_118_fu_448_p2 = (SeparableConv2D_3_m_s_q0 + tmp_117_reg_616);

assign tmp_120_cast_fu_424_p1 = $signed(tmp_113_fu_419_p2);

assign tmp_fu_266_p2 = (phi_mul_reg_129 + tmp_106_fu_262_p1);
...
always @ (posedge ap_clk) begin
    ...
    tmp_103_cast1_reg_514[16] <= 1'b0;
    p_shl_cast_reg_519[2:0] <= 3'b000;
    p_shl_cast_reg_519[20:19] <= 2'b00;
    tmp_107_cast_reg_537[16] <= 1'b0;
    tmp_108_cast_reg_555[16] <= 1'b0;
end
