...
set Interfaces {
    ...
    ap_clk {
        ...
        buses "s_axi_AXILiteS input_data output_data"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
