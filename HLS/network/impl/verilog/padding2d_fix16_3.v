...
wire   [16:0] tmp_47_fu_339_p2;
reg   [16:0] tmp_47_reg_619;
wire   [16:0] tmp_48_fu_345_p2;
reg   [16:0] tmp_48_reg_624;
wire   [15:0] tmp_49_fu_356_p2;
...
wire   [15:0] tmp_52_fu_404_p2;
wire   [0:0] tmp_50_fu_388_p2;
(* use_dsp48 = "no" *) wire   [15:0] i_count_3_fu_410_p2;
reg   [15:0] i_count_3_reg_660;
(* use_dsp48 = "no" *) wire   [15:0] tmp_53_fu_420_p2;
reg   [15:0] tmp_53_reg_665;
wire   [15:0] height_1_fu_430_p2;
reg   [15:0] height_1_reg_674;
wire    ap_CS_fsm_state5;
wire   [15:0] tmp_55_fu_436_p2;
reg   [15:0] tmp_55_reg_679;
wire   [0:0] exitcond7_fu_425_p2;
wire   [15:0] tmp_54_fu_441_p2;
reg   [15:0] tmp_54_reg_684;
wire    ap_CS_fsm_state6;
wire   [0:0] exitcond_fu_445_p2;
wire   [15:0] tmp_61_fu_456_p2;
reg   [15:0] tmp_61_reg_697;
wire   [15:0] tmp_58_fu_462_p2;
reg   [15:0] tmp_58_reg_702;
...
reg   [15:0] i2_reg_293;
wire   [63:0] tmp_51_fu_399_p1;
wire   [63:0] tmp_59_fu_451_p1;
wire   [63:0] tmp_60_fu_467_p1;
wire   [63:0] tmp_62_fu_484_p1;
wire   [63:0] tmp_57_fu_520_p1;
...
wire  signed [15:0] tmp_55_fu_436_p1;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        depth_reg_166 <= 16'd0;
    end else if (((1'b1 == ap_CS_fsm_state9) & (tmp_56_fu_509_p2 == 1'd0))) begin
        depth_reg_166 <= depth_1_reg_642;
    end
end

always @ (posedge ap_clk) begin
    if (((tmp_50_fu_388_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
...
always @ (posedge ap_clk) begin
    if (((tmp_56_fu_509_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state9))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state3) & (exitcond1_fu_373_p2 == 1'd0))) begin
        i_reg_187 <= 16'd0;
    end else if (((tmp_50_fu_388_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state9)) begin
        output_r_address0 = tmp_57_fu_520_p1;
    end else if ((1'b1 == ap_CS_fsm_state8)) begin
        output_r_address0 = tmp_62_fu_484_p1;
    end else if ((1'b1 == ap_CS_fsm_state7)) begin
        output_r_address0 = tmp_60_fu_467_p1;
    end else if ((1'b1 == ap_CS_fsm_state4)) begin
        output_r_address0 = tmp_51_fu_399_p1;
    end else begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state7) | ((tmp_50_fu_388_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4)) | ((tmp_56_fu_509_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state9)) | ((1'b1 == ap_CS_fsm_state8) & (exitcond5_fu_478_p2 == 1'd0)))) begin
        output_r_we0 = 1'b1;
    end else begin
        output_r_we0 = 1'b0;
    end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state9 : begin
            if (((1'b1 == ap_CS_fsm_state9) & (tmp_56_fu_509_p2 == 1'd0))) begin
                ap_NS_fsm = ap_ST_fsm_state3;
            end else begin
                ap_NS_fsm = ap_ST_fsm_state9;
            end
...
assign input_r_address0 = tmp_59_fu_451_p1;
...
assign tmp_47_fu_339_p2 = (17'd3 + tmp_47_cast_fu_336_p1);

assign tmp_48_fu_345_p2 = (17'd1 + tmp_47_cast_fu_336_p1);

assign tmp_49_fu_356_p2 = (16'd5 + tmp_11_fu_351_p2);

assign tmp_50_fu_388_p2 = ((tmp_52_cast_fu_384_p1 < tmp_47_reg_619) ? 1'b1 : 1'b0);

assign tmp_51_fu_399_p1 = o_count_1_reg_177;

assign tmp_52_cast_fu_384_p1 = i_reg_187;

assign tmp_52_fu_404_p2 = (o_count_1_reg_177 + 16'd1);

assign tmp_53_fu_420_p2 = ($signed(tmp2_fu_415_p2) + $signed(tmp_41_reg_580));

assign tmp_54_fu_441_p2 = (tmp_53_reg_665 + tmp_43_reg_603);

assign tmp_55_fu_436_p1 = input_width;

assign tmp_55_fu_436_p2 = ($signed(i_count_1_reg_231) + $signed(tmp_55_fu_436_p1));

assign tmp_56_fu_509_p2 = ((tmp_60_cast_fu_505_p1 < tmp_48_reg_624) ? 1'b1 : 1'b0);

assign tmp_57_fu_520_p1 = o_count_5_reg_284;

assign tmp_58_fu_462_p2 = ($signed(tmp_reg_573) + $signed(o_count_2_reg_220));

assign tmp_59_fu_451_p1 = i_count_2_reg_264;

assign tmp_60_cast_fu_505_p1 = i2_reg_293;

assign tmp_60_fu_467_p1 = o_count_3_reg_253;

assign tmp_61_fu_456_p2 = (i_count_2_reg_264 + 16'd1);

assign tmp_62_fu_484_p1 = o_count_4_reg_274;
