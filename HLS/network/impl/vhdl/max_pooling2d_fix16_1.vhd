...
architecture behav of max_pooling2d_fix16_1 is 
    ...
    signal tmp_69_fu_186_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_69_reg_407 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_70_fu_190_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_70_reg_412 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_71_fu_194_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_71_reg_417 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal tmp_82_cast_fu_248_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_82_cast_reg_453 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal tmp_85_cast_fu_279_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_85_cast_reg_471 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal tmp_79_fu_328_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_79_reg_504 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal tmp_80_fu_348_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_80_reg_518 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tmp_77_fu_288_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_87_fu_362_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_83_fu_376_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_84_fu_381_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_72_fu_230_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_73_fu_240_p3 : STD_LOGIC_VECTOR (16 downto 0);
    signal tmp1_fu_252_p0 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp_75_fu_271_p3 : STD_LOGIC_VECTOR (16 downto 0);
    signal tmp_74_fu_267_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_76_fu_283_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_78_fu_309_p1 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal tmp_85_fu_353_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_86_fu_357_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_81_fu_367_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_82_fu_371_p2 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond2_fu_256_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state5))) then
                MaxPooling2D_0_array_1_reg_476 <= tmp_77_fu_288_p1(12 - 1 downto 0);
                    tmp_85_cast_reg_471(16 downto 1) <= tmp_85_cast_fu_279_p1(16 downto 1);
            end if;
        end if;
    end process;
    process (ap_clk)
        ...
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state4)) then
                tmp1_reg_458 <= tmp1_fu_252_p2;
                    tmp_82_cast_reg_453(16 downto 1) <= tmp_82_cast_fu_248_p1(16 downto 1);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start = ap_const_logic_1))) then
                    tmp_69_reg_407(15 downto 0) <= tmp_69_fu_186_p1(15 downto 0);
                    tmp_70_reg_412(15 downto 0) <= tmp_70_fu_190_p1(15 downto 0);
                    tmp_71_reg_417(15 downto 0) <= tmp_71_fu_194_p1(15 downto 0);
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state8)) then
                tmp_79_reg_504 <= tmp_79_fu_328_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond_fu_336_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state9))) then
                tmp_80_reg_518 <= tmp_80_fu_348_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    tmp_69_reg_407(31 downto 16) <= "0000000000000000";
    tmp_70_reg_412(31 downto 16) <= "0000000000000000";
    tmp_71_reg_417(31 downto 16) <= "0000000000000000";
    tmp_82_cast_reg_453(0) <= '0';
    tmp_82_cast_reg_453(31 downto 17) <= "000000000000000";
    tmp_85_cast_reg_471(0) <= '0';
    tmp_85_cast_reg_471(31 downto 17) <= "000000000000000";
    ...
    Conv2D_0_array_address0_assign_proc : process(ap_CS_fsm_state9, tmp_80_fu_348_p2, exitcond_fu_336_p2, tmp_87_fu_362_p1, tmp_83_fu_376_p1)
    begin
        if (((exitcond_fu_336_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state9))) then
            if ((tmp_80_fu_348_p2 = ap_const_lv1_1)) then 
                Conv2D_0_array_address0 <= tmp_83_fu_376_p1(14 - 1 downto 0);
            elsif ((tmp_80_fu_348_p2 = ap_const_lv1_0)) then 
                Conv2D_0_array_address0 <= tmp_87_fu_362_p1(14 - 1 downto 0);
            else 
    ...
    Conv2D_0_array_ce0_assign_proc : process(ap_CS_fsm_state9, tmp_80_fu_348_p2, exitcond_fu_336_p2)
    begin
        if ((((exitcond_fu_336_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state9) and (tmp_80_fu_348_p2 = ap_const_lv1_1)) or ((exitcond_fu_336_p2 = ap_const_lv1_0) and (tmp_80_fu_348_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state9)))) then 
    ...
    MaxPooling2D_0_array_ce0_assign_proc : process(ap_CS_fsm_state9, tmp_80_reg_518, ap_CS_fsm_state10, tmp_84_fu_381_p2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state9) or ((ap_const_logic_1 = ap_CS_fsm_state10) and (tmp_84_fu_381_p2 = ap_const_lv1_1) and (tmp_80_reg_518 = ap_const_lv1_1)) or ((tmp_80_reg_518 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state10)))) then 
    ...
    MaxPooling2D_0_array_we0_assign_proc : process(tmp_80_reg_518, ap_CS_fsm_state10, tmp_84_fu_381_p2)
    begin
        if ((((ap_const_logic_1 = ap_CS_fsm_state10) and (tmp_84_fu_381_p2 = ap_const_lv1_1) and (tmp_80_reg_518 = ap_const_lv1_1)) or ((tmp_80_reg_518 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state10)))) then 
    ...
    next_mul3_fu_198_p2 <= std_logic_vector(unsigned(phi_mul2_reg_125) + unsigned(tmp_70_reg_412));
    ...
    tmp1_fu_252_p0 <= tmp_71_reg_417(16 - 1 downto 0);
    ...
    tmp2_fu_319_p2 <= std_logic_vector(unsigned(tmp4_fu_313_p2) + unsigned(tmp_82_cast_reg_453));
    tmp3_fu_324_p1 <= tmp_69_reg_407(16 - 1 downto 0);
    ...
    tmp4_fu_313_p2 <= std_logic_vector(unsigned(phi_mul_reg_113) + unsigned(tmp_78_fu_309_p1));
    tmp_18_fu_293_p1 <= in_h_reg_160(1 - 1 downto 0);
    tmp_19_fu_332_p1 <= in_w_reg_171(1 - 1 downto 0);
    tmp_69_fu_186_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(input_width),32));
    tmp_70_fu_190_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(output_height),32));
    tmp_71_fu_194_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(output_width),32));
    tmp_72_fu_230_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(out_h_reg_137),32));
    tmp_73_fu_240_p3 <= (out_h_reg_137 & ap_const_lv1_0);
    tmp_74_fu_267_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(out_w_reg_149),32));
    tmp_75_fu_271_p3 <= (out_w_reg_149 & ap_const_lv1_0);
    tmp_76_fu_283_p2 <= std_logic_vector(unsigned(tmp_74_fu_267_p1) + unsigned(tmp1_reg_458));
        tmp_77_fu_288_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_76_fu_283_p2),64));

    tmp_78_fu_309_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(in_h_reg_160),32));
    tmp_79_fu_328_p2 <= std_logic_vector(unsigned(tmp3_reg_499) + unsigned(tmp_85_cast_reg_471));
    tmp_80_fu_348_p2 <= (tmp_19_fu_332_p1 or tmp_18_reg_481);
    tmp_81_fu_367_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(in_w_reg_171),32));
    tmp_82_cast_fu_248_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_73_fu_240_p3),32));
    tmp_82_fu_371_p2 <= std_logic_vector(unsigned(tmp_79_reg_504) + unsigned(tmp_81_fu_367_p1));
        tmp_83_fu_376_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_82_fu_371_p2),64));

    tmp_84_fu_381_p2 <= "1" when (signed(MaxPooling2D_0_array_q0) < signed(Conv2D_0_array_q0)) else "0";
    tmp_85_cast_fu_279_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_75_fu_271_p3),32));
    tmp_85_fu_353_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(in_w_reg_171),32));
    tmp_86_fu_357_p2 <= std_logic_vector(unsigned(tmp_79_reg_504) + unsigned(tmp_85_fu_353_p1));
        tmp_87_fu_362_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_86_fu_357_p2),64));

    tmp_fu_234_p2 <= std_logic_vector(unsigned(tmp_72_fu_230_p1) + unsigned(phi_mul2_reg_125));
