...
architecture behav of max_pooling2d_fix16 is 
    ...
    signal tmp_87_fu_186_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_87_reg_407 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_88_fu_190_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_88_reg_412 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_89_fu_194_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_89_reg_417 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal tmp_94_cast_fu_248_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_94_cast_reg_453 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal tmp_96_cast_fu_279_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_96_cast_reg_471 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal tmp_100_fu_328_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_100_reg_504 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal tmp_101_fu_348_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_101_reg_518 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tmp_98_fu_288_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_106_fu_362_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_107_fu_376_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_108_fu_381_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_93_fu_230_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_94_fu_240_p3 : STD_LOGIC_VECTOR (16 downto 0);
    signal tmp1_fu_252_p0 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp_96_fu_271_p3 : STD_LOGIC_VECTOR (16 downto 0);
    signal tmp_95_fu_267_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_97_fu_283_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_99_fu_309_p1 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal tmp_104_fu_353_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_105_fu_357_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_102_fu_367_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_103_fu_371_p2 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond2_fu_256_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state5))) then
                MaxPooling2D_1_array_1_reg_476 <= tmp_98_fu_288_p1(9 - 1 downto 0);
                    tmp_96_cast_reg_471(16 downto 1) <= tmp_96_cast_fu_279_p1(16 downto 1);
            end if;
        end if;
    end process;
    process (ap_clk)
        ...
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state4)) then
                tmp1_reg_458 <= tmp1_fu_252_p2;
                    tmp_94_cast_reg_453(16 downto 1) <= tmp_94_cast_fu_248_p1(16 downto 1);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start = ap_const_logic_1))) then
                    tmp_87_reg_407(15 downto 0) <= tmp_87_fu_186_p1(15 downto 0);
                    tmp_88_reg_412(15 downto 0) <= tmp_88_fu_190_p1(15 downto 0);
                    tmp_89_reg_417(15 downto 0) <= tmp_89_fu_194_p1(15 downto 0);
    ...
    tmp_87_reg_407(31 downto 16) <= "0000000000000000";
    tmp_88_reg_412(31 downto 16) <= "0000000000000000";
    tmp_89_reg_417(31 downto 16) <= "0000000000000000";
    tmp_94_cast_reg_453(0) <= '0';
    tmp_94_cast_reg_453(31 downto 17) <= "000000000000000";
    tmp_96_cast_reg_471(0) <= '0';
    tmp_96_cast_reg_471(31 downto 17) <= "000000000000000";
    ...
    MaxPooling2D_1_array_ce0_assign_proc : process(ap_CS_fsm_state9, tmp_101_reg_518, ap_CS_fsm_state10, tmp_108_fu_381_p2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state9) or ((ap_const_logic_1 = ap_CS_fsm_state10) and (tmp_108_fu_381_p2 = ap_const_lv1_1) and (tmp_101_reg_518 = ap_const_lv1_1)) or ((tmp_101_reg_518 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state10)))) then 
    ...
    MaxPooling2D_1_array_we0_assign_proc : process(tmp_101_reg_518, ap_CS_fsm_state10, tmp_108_fu_381_p2)
    begin
        if ((((ap_const_logic_1 = ap_CS_fsm_state10) and (tmp_108_fu_381_p2 = ap_const_lv1_1) and (tmp_101_reg_518 = ap_const_lv1_1)) or ((tmp_101_reg_518 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state10)))) then 
    ...
    input_r_address0_assign_proc : process(ap_CS_fsm_state9, tmp_101_fu_348_p2, exitcond_fu_336_p2, tmp_106_fu_362_p1, tmp_107_fu_376_p1)
    begin
        if (((exitcond_fu_336_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state9))) then
            if ((tmp_101_fu_348_p2 = ap_const_lv1_1)) then 
                input_r_address0 <= tmp_107_fu_376_p1(11 - 1 downto 0);
            elsif ((tmp_101_fu_348_p2 = ap_const_lv1_0)) then 
                input_r_address0 <= tmp_106_fu_362_p1(11 - 1 downto 0);
            else 
    ...
    input_r_ce0_assign_proc : process(ap_CS_fsm_state9, tmp_101_fu_348_p2, exitcond_fu_336_p2)
    begin
        if ((((exitcond_fu_336_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state9) and (tmp_101_fu_348_p2 = ap_const_lv1_1)) or ((exitcond_fu_336_p2 = ap_const_lv1_0) and (tmp_101_fu_348_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state9)))) then 
    ...
    next_mul3_fu_198_p2 <= std_logic_vector(unsigned(phi_mul2_reg_125) + unsigned(tmp_88_reg_412));
    ...
    tmp1_fu_252_p0 <= tmp_89_reg_417(16 - 1 downto 0);
    ...
    tmp2_fu_319_p2 <= std_logic_vector(unsigned(tmp4_fu_313_p2) + unsigned(tmp_94_cast_reg_453));
    tmp3_fu_324_p1 <= tmp_87_reg_407(16 - 1 downto 0);
    ...
    tmp4_fu_313_p2 <= std_logic_vector(unsigned(phi_mul_reg_113) + unsigned(tmp_99_fu_309_p1));
    tmp_100_fu_328_p2 <= std_logic_vector(unsigned(tmp3_reg_499) + unsigned(tmp_96_cast_reg_471));
    tmp_101_fu_348_p2 <= (tmp_23_fu_332_p1 or tmp_22_reg_481);
    tmp_102_fu_367_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(in_w_reg_171),32));
    tmp_103_fu_371_p2 <= std_logic_vector(unsigned(tmp_100_reg_504) + unsigned(tmp_102_fu_367_p1));
    tmp_104_fu_353_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(in_w_reg_171),32));
    tmp_105_fu_357_p2 <= std_logic_vector(unsigned(tmp_100_reg_504) + unsigned(tmp_104_fu_353_p1));
        tmp_106_fu_362_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_105_fu_357_p2),64));

        tmp_107_fu_376_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_103_fu_371_p2),64));

    tmp_108_fu_381_p2 <= "1" when (signed(MaxPooling2D_1_array_q0) < signed(input_r_q0)) else "0";
    tmp_22_fu_293_p1 <= in_h_reg_160(1 - 1 downto 0);
    tmp_23_fu_332_p1 <= in_w_reg_171(1 - 1 downto 0);
    tmp_87_fu_186_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(input_width),32));
    tmp_88_fu_190_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(output_height),32));
    tmp_89_fu_194_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(output_width),32));
    tmp_93_fu_230_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(out_h_reg_137),32));
    tmp_94_cast_fu_248_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_94_fu_240_p3),32));
    tmp_94_fu_240_p3 <= (out_h_reg_137 & ap_const_lv1_0);
    tmp_95_fu_267_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(out_w_reg_149),32));
    tmp_96_cast_fu_279_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_96_fu_271_p3),32));
    tmp_96_fu_271_p3 <= (out_w_reg_149 & ap_const_lv1_0);
    tmp_97_fu_283_p2 <= std_logic_vector(unsigned(tmp_95_fu_267_p1) + unsigned(tmp1_reg_458));
        tmp_98_fu_288_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_97_fu_283_p2),64));

    tmp_99_fu_309_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(in_h_reg_160),32));
    tmp_fu_234_p2 <= std_logic_vector(unsigned(tmp_93_fu_230_p1) + unsigned(phi_mul2_reg_125));
