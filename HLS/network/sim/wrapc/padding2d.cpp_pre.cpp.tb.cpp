// ==============================================================
// File generated on Sat Nov 02 18:32:49 JST 2019
// Vivado(TM) HLS - High-Level Synthesis from C, C++ and SystemC v2018.3 (64-bit)
// SW Build 2405991 on Thu Dec  6 23:36:41 MST 2018
// IP Build 2404404 on Fri Dec  7 01:43:56 MST 2018
// Copyright 1986-2018 Xilinx, Inc. All Rights Reserved.
// ==============================================================
#1 "/home/masudalab/DeepCAEonFPGA/layers_c/padding2d.cpp"
#1 "<built-in>"
#1 "<command-line>"
...
#2 "/home/masudalab/DeepCAEonFPGA/layers_c/padding2d.cpp" 2
#1 "/home/masudalab/DeepCAEonFPGA/layers_c/padding2d.h" 1



#3 "/home/masudalab/DeepCAEonFPGA/layers_c/padding2d.h"
...
#3 "/home/masudalab/DeepCAEonFPGA/layers_c/padding2d.cpp" 2
...
uint8_t padding2d_fix16(uint16_t padding_height, uint16_t padding_width,
  ...
  int16_t* output) {
#40 "/home/masudalab/DeepCAEonFPGA/layers_c/padding2d.cpp"
...
uint8_t padding2d_float32(uint16_t padding_height, uint16_t padding_width,
  uint16_t input_depth, uint16_t input_height, uint16_t input_width,
  float* input, uint16_t output_height, uint16_t output_width,
  float* output) {

 for (uint16_t depth = 0; depth < input_depth; depth++) {
  for (uint16_t height = 0; height < padding_height * 2 + input_height;
    height++) {
   if (height < padding_height) {
    for (uint16_t width = 0;
      width < padding_width * 2 + input_width; width++) {

     output[depth * output_height * output_width
       + height * output_width + width] = 0;
    }
   } else if (height >= padding_height
     && height < padding_height + input_height) {
    for (uint16_t width = 0;
      width < padding_width * 2 + input_width; width++) {
     if (width < padding_width) {
      ...
      output[depth * output_height * output_width
        + height * output_width + width] = 0;
     } else if (width >= padding_width
       && width < padding_width + input_width) {
