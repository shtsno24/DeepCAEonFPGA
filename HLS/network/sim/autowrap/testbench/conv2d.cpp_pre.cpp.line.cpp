#pragma line 1 "/home/masudalab/DeepCAEonFPGA/layers_c/conv2d.cpp"
...
#pragma line 2 "/home/masudalab/DeepCAEonFPGA/layers_c/conv2d.cpp" 2
#pragma line 1 "/home/masudalab/DeepCAEonFPGA/layers_c/conv2d.h" 1
#pragma empty_line
#pragma empty_line
#pragma line 2 "/home/masudalab/DeepCAEonFPGA/layers_c/conv2d.h"
...
uint8_t relu);
#pragma line 3 "/home/masudalab/DeepCAEonFPGA/layers_c/conv2d.cpp" 2
#pragma empty_line
#pragma empty_line
uint8_t conv2d_fix16(uint16_t input_depth, uint16_t input_height, uint16_t input_width, int16_t* input,
uint16_t output_depth, uint16_t output_height, uint16_t output_width, int16_t* output,
...
uint16_t kernel_height, uint16_t kernel_width, const float* kernel,
uint8_t relu){
#pragma line 64 "/home/masudalab/DeepCAEonFPGA/layers_c/conv2d.cpp"
    for(uint16_t out_d = 0; out_d < output_depth; out_d++){
        for(uint16_t out_h = 0; out_h < output_height; out_h++){
            for(uint16_t out_w = 0; out_w < output_width; out_w++){
                output[out_d * output_height * output_width + out_h * output_width + out_w] = 0;
