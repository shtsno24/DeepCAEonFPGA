...
wire   [15:0] tmp_11_fu_297_p2;
reg   [15:0] tmp_11_reg_573;
...
wire   [15:0] tmp_13_fu_332_p2;
reg   [15:0] tmp_13_reg_605;
wire   [15:0] tmp_14_fu_343_p2;
reg   [15:0] tmp_14_reg_610;
wire   [15:0] depth_1_fu_354_p2;
reg   [15:0] depth_1_reg_618;
wire    ap_CS_fsm_state3;
wire   [15:0] i_1_fu_369_p2;
wire    ap_CS_fsm_state4;
wire   [15:0] tmp_49_fu_380_p2;
wire   [0:0] tmp_s_fu_364_p2;
wire   [15:0] tmp_50_fu_392_p2;
(* use_dsp48 = "no" *) wire   [15:0] i_count_3_fu_397_p2;
reg   [15:0] i_count_3_reg_641;
(* use_dsp48 = "no" *) wire   [15:0] tmp_51_fu_407_p2;
reg   [15:0] tmp_51_reg_646;
wire   [15:0] height_1_fu_417_p2;
reg   [15:0] height_1_reg_655;
wire    ap_CS_fsm_state5;
wire   [15:0] tmp_52_fu_423_p2;
reg   [15:0] tmp_52_reg_660;
wire   [0:0] exitcond2_fu_412_p2;
wire   [15:0] o_count_8_fu_438_p2;
wire    ap_CS_fsm_state6;
wire   [0:0] exitcond3_fu_427_p2;
wire   [15:0] tmp_55_fu_444_p2;
reg   [15:0] tmp_55_reg_673;
wire   [15:0] tmp_56_fu_449_p2;
reg   [15:0] tmp_56_reg_678;
wire    ap_CS_fsm_state7;
wire   [0:0] exitcond_fu_454_p2;
wire   [15:0] tmp_60_fu_465_p2;
reg   [15:0] tmp_60_reg_691;
...
reg   [15:0] i2_reg_280;
wire   [63:0] tmp_48_fu_375_p1;
wire   [63:0] tmp_57_fu_433_p1;
wire   [63:0] tmp_58_fu_460_p1;
wire   [63:0] tmp_59_fu_481_p1;
wire   [63:0] tmp_54_fu_507_p1;
wire  signed [15:0] tmp_fu_291_p1;
wire  signed [15:0] tmp_11_fu_297_p0;
...
wire  signed [15:0] tmp_55_fu_444_p1;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        depth_reg_154 <= 16'd0;
    end else if (((1'b1 == ap_CS_fsm_state9) & (tmp_53_fu_496_p2 == 1'd0))) begin
        depth_reg_154 <= depth_1_reg_618;
    end
end

always @ (posedge ap_clk) begin
    if (((tmp_s_fu_364_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
...
always @ (posedge ap_clk) begin
    if (((tmp_53_fu_496_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state9))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state3) & (exitcond1_fu_349_p2 == 1'd0))) begin
        i_reg_175 <= 16'd0;
    end else if (((tmp_s_fu_364_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        tmp_11_reg_573[15 : 1] <= tmp_11_fu_297_p2[15 : 1];
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state9)) begin
        output_r_address0 = tmp_54_fu_507_p1;
    end else if ((1'b1 == ap_CS_fsm_state8)) begin
        output_r_address0 = tmp_59_fu_481_p1;
    end else if ((1'b1 == ap_CS_fsm_state6)) begin
        output_r_address0 = tmp_57_fu_433_p1;
    end else if ((1'b1 == ap_CS_fsm_state4)) begin
        output_r_address0 = tmp_48_fu_375_p1;
    end else begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state8) | ((tmp_s_fu_364_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4)) | ((tmp_53_fu_496_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state9)) | ((1'b1 == ap_CS_fsm_state6) & (exitcond3_fu_427_p2 == 1'd0)))) begin
        output_r_we0 = 1'b1;
    end else begin
        output_r_we0 = 1'b0;
    end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state9 : begin
            if (((1'b1 == ap_CS_fsm_state9) & (tmp_53_fu_496_p2 == 1'd0))) begin
                ap_NS_fsm = ap_ST_fsm_state3;
            end else begin
                ap_NS_fsm = ap_ST_fsm_state9;
            end
...
assign indvars_iv_next1_fu_518_p2 = (indvars_iv2_reg_120 + tmp_13_reg_605);
...
assign indvars_iv_next_fu_523_p2 = (indvars_iv_reg_110 + tmp_14_reg_610);

assign input_r_address0 = tmp_58_fu_460_p1;
...
assign tmp_11_fu_297_p0 = input_width;

assign tmp_11_fu_297_p2 = tmp_11_fu_297_p0 << 16'd1;

assign tmp_13_fu_332_p2 = (tmp3_fu_327_p2 + tmp_46_fu_316_p2);

assign tmp_14_fu_343_p2 = (tmp4_fu_338_p2 + tmp_11_fu_297_p2);
...
assign tmp_48_fu_375_p1 = o_count_1_reg_165;

assign tmp_49_fu_380_p2 = (o_count_1_reg_165 + 16'd1);

assign tmp_50_fu_392_p2 = (tmp1_fu_386_p2 + tmp_11_reg_573);

assign tmp_51_fu_407_p2 = ($signed(tmp2_fu_402_p2) + $signed(tmp_42_reg_561));

assign tmp_52_fu_423_p2 = (tmp_51_reg_646 + tmp_46_reg_594);

assign tmp_53_fu_496_p2 = ((tmp_57_cast_fu_492_p1 < tmp_47_reg_600) ? 1'b1 : 1'b0);

assign tmp_54_fu_507_p1 = o_count_5_reg_271;

assign tmp_55_fu_444_p1 = input_width;

assign tmp_55_fu_444_p2 = ($signed(i_count_1_reg_218) + $signed(tmp_55_fu_444_p1));

assign tmp_56_fu_449_p2 = ($signed(tmp_reg_554) + $signed(o_count_2_reg_207));

assign tmp_57_cast_fu_492_p1 = i2_reg_280;

assign tmp_57_fu_433_p1 = o_count_3_reg_240;

assign tmp_58_fu_460_p1 = i_count_2_reg_261;

assign tmp_59_fu_481_p1 = o_count_4_reg_250;

assign tmp_60_fu_465_p2 = (i_count_2_reg_261 + 16'd1);

assign tmp_fu_291_p1 = input_width;

assign tmp_fu_291_p2 = ($signed(16'd2) + $signed(tmp_fu_291_p1));

assign tmp_s_fu_364_p2 = ((tmp_48_cast_fu_360_p1 < tmp_45_reg_589) ? 1'b1 : 1'b0);

always @ (posedge ap_clk) begin
    tmp_11_reg_573[0] <= 1'b0;
end
