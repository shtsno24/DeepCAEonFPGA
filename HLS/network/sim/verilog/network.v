...
(* CORE_GENERATION_INFO="network,hls_ip_2018_3_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.585000,HLS_SYN_LAT=125889,HLS_SYN_TPT=none,HLS_SYN_MEM=49,HLS_SYN_DSP=2,HLS_SYN_FF=717,HLS_SYN_LUT=1786,HLS_VERSION=2018_3_1}" *)
...
reg   [0:0] tmp_11_reg_354;
reg    ap_enable_reg_pp0_iter2;
reg   [0:0] tmp_11_reg_354_pp0_iter1_reg;
reg   [13:0] i2_reg_226;
wire   [9:0] i_2_fu_265_p2;
reg    ap_block_state2;
wire   [0:0] tmp_9_fu_281_p2;
wire    ap_CS_fsm_state8;
wire   [13:0] i_3_fu_287_p2;
reg   [13:0] i_3_reg_339;
wire   [63:0] tmp_10_fu_293_p1;
reg   [63:0] tmp_10_reg_344;
wire   [0:0] tmp_11_fu_298_p2;
...
wire   [13:0] i_4_fu_304_p2;
reg    ap_enable_reg_pp0_iter0;
wire   [0:0] tmp_user_V_fu_315_p2;
...
reg    MemBank_Out_ce0;
reg    MemBank_Out_we0;
wire    grp_padding2d_fix16_fu_237_ap_start;
wire    grp_padding2d_fix16_fu_237_ap_done;
wire    grp_padding2d_fix16_fu_237_ap_idle;
wire    grp_padding2d_fix16_fu_237_ap_ready;
wire   [13:0] grp_padding2d_fix16_fu_237_input_r_address0;
wire    grp_padding2d_fix16_fu_237_input_r_ce0;
wire   [13:0] grp_padding2d_fix16_fu_237_output_r_address0;
wire    grp_padding2d_fix16_fu_237_output_r_ce0;
wire    grp_padding2d_fix16_fu_237_output_r_we0;
wire   [15:0] grp_padding2d_fix16_fu_237_output_r_d0;
wire    grp_pointwise_conv2d_fix_fu_243_ap_start;
wire    grp_pointwise_conv2d_fix_fu_243_ap_done;
wire    grp_pointwise_conv2d_fix_fu_243_ap_idle;
wire    grp_pointwise_conv2d_fix_fu_243_ap_ready;
wire   [13:0] grp_pointwise_conv2d_fix_fu_243_input_r_address0;
wire    grp_pointwise_conv2d_fix_fu_243_input_r_ce0;
wire   [13:0] grp_pointwise_conv2d_fix_fu_243_output_r_address0;
wire    grp_pointwise_conv2d_fix_fu_243_output_r_ce0;
wire    grp_pointwise_conv2d_fix_fu_243_output_r_we0;
wire   [15:0] grp_pointwise_conv2d_fix_fu_243_output_r_d0;
wire    grp_depthwise_conv2d_fix_fu_251_ap_start;
wire    grp_depthwise_conv2d_fix_fu_251_ap_done;
wire    grp_depthwise_conv2d_fix_fu_251_ap_idle;
wire    grp_depthwise_conv2d_fix_fu_251_ap_ready;
wire   [13:0] grp_depthwise_conv2d_fix_fu_251_input_r_address0;
wire    grp_depthwise_conv2d_fix_fu_251_input_r_ce0;
wire   [13:0] grp_depthwise_conv2d_fix_fu_251_output_r_address0;
wire    grp_depthwise_conv2d_fix_fu_251_output_r_ce0;
wire    grp_depthwise_conv2d_fix_fu_251_output_r_we0;
wire   [15:0] grp_depthwise_conv2d_fix_fu_251_output_r_d0;
reg   [9:0] i_reg_204;
reg   [13:0] i1_reg_215;
wire    ap_CS_fsm_state7;
wire    ap_CS_fsm_state9;
reg    grp_padding2d_fix16_fu_237_ap_start_reg;
reg    ap_block_state2_ignore_call0;
wire    ap_CS_fsm_state3;
reg    grp_pointwise_conv2d_fix_fu_243_ap_start_reg;
wire    ap_CS_fsm_state6;
reg    grp_depthwise_conv2d_fix_fu_251_ap_start_reg;
wire    ap_CS_fsm_state4;
wire    ap_CS_fsm_state5;
wire   [63:0] tmp_s_fu_276_p1;
wire   [63:0] i2_cast1_fu_310_p1;
...
#0 grp_padding2d_fix16_fu_237_ap_start_reg = 1'b0;
#0 grp_pointwise_conv2d_fix_fu_243_ap_start_reg = 1'b0;
#0 grp_depthwise_conv2d_fix_fu_251_ap_start_reg = 1'b0;
end
...
pointwise_conv2d_fix grp_pointwise_conv2d_fix_fu_243(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
    .ap_start(grp_pointwise_conv2d_fix_fu_243_ap_start),
    .ap_done(grp_pointwise_conv2d_fix_fu_243_ap_done),
    .ap_idle(grp_pointwise_conv2d_fix_fu_243_ap_idle),
    .ap_ready(grp_pointwise_conv2d_fix_fu_243_ap_ready),
    .input_r_address0(grp_pointwise_conv2d_fix_fu_243_input_r_address0),
    .input_r_ce0(grp_pointwise_conv2d_fix_fu_243_input_r_ce0),
    .input_r_q0(MemBank_A_q0),
    .output_r_address0(grp_pointwise_conv2d_fix_fu_243_output_r_address0),
    .output_r_ce0(grp_pointwise_conv2d_fix_fu_243_output_r_ce0),
    .output_r_we0(grp_pointwise_conv2d_fix_fu_243_output_r_we0),
    .output_r_d0(grp_pointwise_conv2d_fix_fu_243_output_r_d0)
);

depthwise_conv2d_fix grp_depthwise_conv2d_fix_fu_251(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
    .ap_start(grp_depthwise_conv2d_fix_fu_251_ap_start),
    .ap_done(grp_depthwise_conv2d_fix_fu_251_ap_done),
    .ap_idle(grp_depthwise_conv2d_fix_fu_251_ap_idle),
    .ap_ready(grp_depthwise_conv2d_fix_fu_251_ap_ready),
    .input_r_address0(grp_depthwise_conv2d_fix_fu_251_input_r_address0),
    .input_r_ce0(grp_depthwise_conv2d_fix_fu_251_input_r_ce0),
    .input_r_q0(MemBank_B_q0),
    .output_r_address0(grp_depthwise_conv2d_fix_fu_251_output_r_address0),
    .output_r_ce0(grp_depthwise_conv2d_fix_fu_251_output_r_ce0),
    .output_r_we0(grp_depthwise_conv2d_fix_fu_251_output_r_we0),
    .output_r_d0(grp_depthwise_conv2d_fix_fu_251_output_r_d0),
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ...
        if (((1'b0 == ap_block_pp0_stage0_subdone) & (1'b1 == ap_condition_pp0_exit_iter0_state10) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            ap_enable_reg_pp0_iter0 <= 1'b0;
        end else if (((tmp_9_fu_281_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state8))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        grp_depthwise_conv2d_fix_fu_251_ap_start_reg <= 1'b0;
    end else begin
        if ((1'b1 == ap_CS_fsm_state4)) begin
            grp_depthwise_conv2d_fix_fu_251_ap_start_reg <= 1'b1;
        end else if ((grp_depthwise_conv2d_fix_fu_251_ap_ready == 1'b1)) begin
            grp_depthwise_conv2d_fix_fu_251_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        grp_padding2d_fix16_fu_237_ap_start_reg <= 1'b0;
    end else begin
        if ((~((exitcond_fu_259_p2 == 1'd0) & (input_data_V_data_V_0_vld_out == 1'b0)) & (exitcond_fu_259_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
            grp_padding2d_fix16_fu_237_ap_start_reg <= 1'b1;
        end else if ((grp_padding2d_fix16_fu_237_ap_ready == 1'b1)) begin
            grp_padding2d_fix16_fu_237_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        grp_pointwise_conv2d_fix_fu_243_ap_start_reg <= 1'b0;
    end else begin
        if ((1'b1 == ap_CS_fsm_state6)) begin
            grp_pointwise_conv2d_fix_fu_243_ap_start_reg <= 1'b1;
        end else if ((grp_pointwise_conv2d_fix_fu_243_ap_ready == 1'b1)) begin
            grp_pointwise_conv2d_fix_fu_243_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state9)) begin
        i1_reg_215 <= i_3_reg_339;
    end else if (((1'b1 == ap_CS_fsm_state7) & (grp_pointwise_conv2d_fix_fu_243_ap_done == 1'b1))) begin
        i1_reg_215 <= 14'd0;
    end
end

always @ (posedge ap_clk) begin
    if (((tmp_9_fu_281_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state8))) begin
        i2_reg_226 <= 14'd0;
    end else if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_11_fu_298_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        i2_reg_226 <= i_4_fu_304_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((~((exitcond_fu_259_p2 == 1'd0) & (input_data_V_data_V_0_vld_out == 1'b0)) & (exitcond_fu_259_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        i_reg_204 <= i_2_fu_265_p2;
...
always @ (posedge ap_clk) begin
    if (((tmp_9_fu_281_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state8))) begin
        tmp_10_reg_344[13 : 0] <= tmp_10_fu_293_p1[13 : 0];
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        tmp_11_reg_354 <= tmp_11_fu_298_p2;
        tmp_11_reg_354_pp0_iter1_reg <= tmp_11_reg_354;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_11_fu_298_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((exitcond_fu_259_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        MemBank_A_address0 = tmp_s_fu_276_p1;
    end else if ((1'b1 == ap_CS_fsm_state5)) begin
        MemBank_A_address0 = grp_depthwise_conv2d_fix_fu_251_output_r_address0;
    end else if ((1'b1 == ap_CS_fsm_state7)) begin
        MemBank_A_address0 = grp_pointwise_conv2d_fix_fu_243_input_r_address0;
...
always @ (*) begin
    if ((~((exitcond_fu_259_p2 == 1'd0) & (input_data_V_data_V_0_vld_out == 1'b0)) & (exitcond_fu_259_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        ...
        MemBank_A_ce0 = grp_depthwise_conv2d_fix_fu_251_output_r_ce0;
    end else if ((1'b1 == ap_CS_fsm_state7)) begin
        MemBank_A_ce0 = grp_pointwise_conv2d_fix_fu_243_input_r_ce0;
    end else if ((1'b1 == ap_CS_fsm_state3)) begin
...
always @ (*) begin
    if (((exitcond_fu_259_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        ...
        MemBank_A_d0 = grp_depthwise_conv2d_fix_fu_251_output_r_d0;
    end else begin
        MemBank_A_d0 = 'bx;
    end
end
...
always @ (*) begin
    if ((~((exitcond_fu_259_p2 == 1'd0) & (input_data_V_data_V_0_vld_out == 1'b0)) & (exitcond_fu_259_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        ...
        MemBank_A_we0 = grp_depthwise_conv2d_fix_fu_251_output_r_we0;
    end else begin
        MemBank_A_we0 = 1'b0;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        MemBank_B_address0 = tmp_10_fu_293_p1;
    end else if ((1'b1 == ap_CS_fsm_state5)) begin
        MemBank_B_address0 = grp_depthwise_conv2d_fix_fu_251_input_r_address0;
    end else if ((1'b1 == ap_CS_fsm_state7)) begin
        MemBank_B_address0 = grp_pointwise_conv2d_fix_fu_243_output_r_address0;
    end else if ((1'b1 == ap_CS_fsm_state3)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        ...
        MemBank_B_ce0 = grp_depthwise_conv2d_fix_fu_251_input_r_ce0;
    end else if ((1'b1 == ap_CS_fsm_state7)) begin
        MemBank_B_ce0 = grp_pointwise_conv2d_fix_fu_243_output_r_ce0;
    end else if ((1'b1 == ap_CS_fsm_state3)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state7)) begin
        MemBank_B_d0 = grp_pointwise_conv2d_fix_fu_243_output_r_d0;
    end else if ((1'b1 == ap_CS_fsm_state3)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state7)) begin
        MemBank_B_we0 = grp_pointwise_conv2d_fix_fu_243_output_r_we0;
    end else if ((1'b1 == ap_CS_fsm_state3)) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        MemBank_Out_address0 = i2_cast1_fu_310_p1;
    end else if ((1'b1 == ap_CS_fsm_state9)) begin
        MemBank_Out_address0 = tmp_10_reg_344;
    end else begin
...
always @ (*) begin
    if ((tmp_11_fu_298_p2 == 1'd1)) begin
...
always @ (*) begin
    if ((((1'b0 == ap_block_pp0_stage0) & (tmp_11_reg_354_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((1'b0 == ap_block_pp0_stage0) & (tmp_11_reg_354 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_11_reg_354 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if ((~((exitcond_fu_259_p2 == 1'd0) & (input_data_V_data_V_0_vld_out == 1'b0)) & (exitcond_fu_259_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else if ((~((exitcond_fu_259_p2 == 1'd0) & (input_data_V_data_V_0_vld_out == 1'b0)) & (exitcond_fu_259_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        ...
        ap_ST_fsm_state3 : begin
            if (((1'b1 == ap_CS_fsm_state3) & (grp_padding2d_fix16_fu_237_ap_done == 1'b1))) begin
        ...
        ap_ST_fsm_state5 : begin
            if (((1'b1 == ap_CS_fsm_state5) & (grp_depthwise_conv2d_fix_fu_251_ap_done == 1'b1))) begin
        ...
        ap_ST_fsm_state7 : begin
            if (((1'b1 == ap_CS_fsm_state7) & (grp_pointwise_conv2d_fix_fu_243_ap_done == 1'b1))) begin
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (tmp_11_fu_298_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1)) & ~((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (tmp_11_fu_298_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1)) | ((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)))) begin
...
always @ (*) begin
    ap_block_state11_io = ((tmp_11_reg_354 == 1'd0) & (output_data_V_data_V_1_ack_in == 1'b0));
end

assign ap_block_state11_pp0_stage0_iter1 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state12_io = ((tmp_11_reg_354_pp0_iter1_reg == 1'd0) & (output_data_V_data_V_1_ack_in == 1'b0));
end
...
always @ (*) begin
    ap_block_state2 = ((exitcond_fu_259_p2 == 1'd0) & (input_data_V_data_V_0_vld_out == 1'b0));
end

always @ (*) begin
    ap_block_state2_ignore_call0 = ((exitcond_fu_259_p2 == 1'd0) & (input_data_V_data_V_0_vld_out == 1'b0));
end
...
assign exitcond_fu_259_p2 = ((i_reg_204 == 10'd784) ? 1'b1 : 1'b0);

assign grp_depthwise_conv2d_fix_fu_251_ap_start = grp_depthwise_conv2d_fix_fu_251_ap_start_reg;

assign grp_padding2d_fix16_fu_237_ap_start = grp_padding2d_fix16_fu_237_ap_start_reg;

assign grp_pointwise_conv2d_fix_fu_243_ap_start = grp_pointwise_conv2d_fix_fu_243_ap_start_reg;

assign i2_cast1_fu_310_p1 = i2_reg_226;

assign i_2_fu_265_p2 = (i_reg_204 + 10'd1);

assign i_3_fu_287_p2 = (i1_reg_215 + 14'd1);

assign i_4_fu_304_p2 = (i2_reg_226 + 14'd1);
...
assign tmp_10_fu_293_p1 = i1_reg_215;

assign tmp_11_fu_298_p2 = ((i2_reg_226 == 14'd12544) ? 1'b1 : 1'b0);

assign tmp_9_fu_281_p2 = ((i1_reg_215 == 14'd12544) ? 1'b1 : 1'b0);

assign tmp_last_V_fu_321_p2 = ((i2_reg_226 == 14'd12543) ? 1'b1 : 1'b0);

assign tmp_s_fu_276_p1 = i_reg_204;

assign tmp_user_V_fu_315_p2 = ((i2_reg_226 == 14'd0) ? 1'b1 : 1'b0);

always @ (posedge ap_clk) begin
    tmp_10_reg_344[63:14] <= 50'b00000000000000000000000000000000000000000000000000;
end
