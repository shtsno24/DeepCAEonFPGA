...
reg   [7:0] Conv2D_0_w_0_address0;
reg    Conv2D_0_w_0_ce0;
wire   [13:0] Conv2D_0_w_0_q0;
reg   [7:0] Conv2D_0_w_0_address1;
reg    Conv2D_0_w_0_ce1;
wire   [13:0] Conv2D_0_w_0_q1;
reg   [7:0] Conv2D_0_w_0_address2;
reg    Conv2D_0_w_0_ce2;
...
wire   [31:0] tmp_105_fu_394_p1;
reg   [31:0] tmp_105_reg_1060;
wire   [31:0] tmp_106_fu_398_p1;
reg   [31:0] tmp_106_reg_1065;
wire   [31:0] tmp_107_fu_402_p1;
reg   [31:0] tmp_107_reg_1070;
wire   [31:0] tmp_108_fu_406_p1;
reg   [31:0] tmp_108_reg_1077;
...
wire  signed [15:0] Conv2D_0_b_load_cast_fu_436_p1;
reg  signed [15:0] Conv2D_0_b_load_cast_reg_1105;
wire    ap_CS_fsm_state3;
wire  signed [14:0] tmp_39_fu_440_p1;
reg  signed [14:0] tmp_39_reg_1110;
wire   [15:0] out_h_3_fu_449_p2;
reg   [15:0] out_h_3_reg_1118;
wire    ap_CS_fsm_state4;
wire   [31:0] tmp_113_fu_455_p1;
reg   [31:0] tmp_113_reg_1123;
...
wire   [31:0] tmp_114_fu_480_p1;
reg   [31:0] tmp_114_reg_1146;
wire   [0:0] exitcond3_fu_469_p2;
reg   [13:0] output_addr11_reg_1153;
...
wire   [31:0] tmp_121_fu_538_p2;
reg   [31:0] tmp_121_reg_1185;
...
wire  signed [31:0] tmp_122_fu_568_p2;
reg  signed [31:0] tmp_122_reg_1215;
wire    ap_CS_fsm_state9;
wire   [31:0] tmp5_1_fu_596_p2;
reg   [31:0] tmp5_1_reg_1242;
wire   [31:0] tmp5_2_fu_600_p2;
reg   [31:0] tmp5_2_reg_1249;
reg   [15:0] tmp_132_reg_1281;
reg  signed [15:0] Padding2D_0_array_lo_3_reg_1286;
...
wire   [63:0] tmp_112_fu_431_p1;
wire  signed [63:0] tmp_116_fu_493_p1;
wire  signed [63:0] tmp_129_fu_577_p1;
wire  signed [63:0] tmp_130_fu_582_p1;
...
wire  signed [10:0] Conv2D_0_b_load_cast_fu_436_p0;
wire  signed [10:0] tmp_39_fu_440_p0;
wire   [15:0] tmp3_fu_465_p1;
wire   [31:0] tmp_115_fu_488_p2;
wire   [16:0] tmp_114_cast_fu_484_p1;
wire   [16:0] tmp_127_0_1_fu_498_p2;
wire   [16:0] tmp_127_0_2_fu_508_p2;
wire   [31:0] tmp_119_fu_529_p1;
wire   [15:0] tmp5_fu_549_p0;
wire   [31:0] tmp_68_fu_563_p2;
wire   [31:0] tmp_128_fu_573_p2;
...
wire  signed [29:0] tmp_131_fu_972_p2;
...
wire   [14:0] tmp_66_fu_938_p1;
wire   [15:0] tmp_117_fu_942_p2;
wire   [0:0] tmp_67_fu_952_p3;
...
network_mul_mul_16s_14s_30_1_1 #(
    ...
    .din1_WIDTH( 14 ),
    .dout_WIDTH( 30 ))
network_mul_mul_16s_14s_30_1_1_U8(
    .din0(reg_370),
    .din1(reg_374),
...
network_mul_mul_16s_14s_30_1_1 #(
    ...
    .din1_WIDTH( 14 ),
    .dout_WIDTH( 30 ))
network_mul_mul_16s_14s_30_1_1_U10(
    .din0(reg_370),
    .din1(reg_382),
...
network_mul_mul_16s_14s_30_1_1 #(
    ...
    .din1_WIDTH( 14 ),
    .dout_WIDTH( 30 ))
network_mul_mul_16s_14s_30_1_1_U13(
    .din0(reg_378),
    .din1(reg_382),
...
network_mul_mul_16s_14s_30_1_1 #(
    ...
    .din1_WIDTH( 14 ),
    .dout_WIDTH( 30 ))
network_mul_mul_16s_14s_30_1_1_U14(
    .din0(reg_370),
    .din1(reg_374),
...
network_mul_mul_16s_14s_30_1_1 #(
    ...
    .din1_WIDTH( 14 ),
    .dout_WIDTH( 30 ))
network_mul_mul_16s_14s_30_1_1_U15(
    .din0(reg_378),
    .din1(reg_382),
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state11)) begin
        ...
        tmp_132_reg_1281 <= {{tmp_131_fu_972_p2[29:14]}};
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state6) & (exitcond3_fu_469_p2 == 1'd0))) begin
        output_addr11_reg_1153 <= tmp_116_fu_493_p1;
        tmp_114_reg_1146[15 : 0] <= tmp_114_fu_480_p1[15 : 0];
...
always @ (posedge ap_clk) begin
    if (((ap_start == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        tmp_105_reg_1060[15 : 0] <= tmp_105_fu_394_p1[15 : 0];
        tmp_106_reg_1065[15 : 0] <= tmp_106_fu_398_p1[15 : 0];
        tmp_107_reg_1070[15 : 0] <= tmp_107_fu_402_p1[15 : 0];
        tmp_108_reg_1077[15 : 0] <= tmp_108_fu_406_p1[15 : 0];
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state4) & (exitcond4_fu_444_p2 == 1'd0))) begin
        tmp_113_reg_1123[15 : 0] <= tmp_113_fu_455_p1[15 : 0];
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state12)) begin
        Conv2D_0_w_0_address0 = tmp_133_2_fu_778_p1;
    end else if ((1'b1 == ap_CS_fsm_state11)) begin
        Conv2D_0_w_0_address0 = tmp_133_1_1_fu_683_p1;
    end else if ((1'b1 == ap_CS_fsm_state10)) begin
        Conv2D_0_w_0_address0 = tmp_133_0_1_fu_609_p1;
    end else if ((1'b1 == ap_CS_fsm_state9)) begin
        Conv2D_0_w_0_address0 = tmp_130_fu_582_p1;
    end else begin
        Conv2D_0_w_0_address0 = 'bx;
    end
end

always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state12)) begin
        Conv2D_0_w_0_address1 = tmp_133_2_1_fu_792_p1;
    end else if ((1'b1 == ap_CS_fsm_state11)) begin
        Conv2D_0_w_0_address1 = tmp_133_1_2_fu_702_p1;
    end else if ((1'b1 == ap_CS_fsm_state10)) begin
        Conv2D_0_w_0_address1 = tmp_133_0_2_fu_628_p1;
    end else begin
        Conv2D_0_w_0_address1 = 'bx;
    end
end

always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state12)) begin
        Conv2D_0_w_0_address2 = tmp_133_2_2_fu_802_p1;
    end else if ((1'b1 == ap_CS_fsm_state10)) begin
        Conv2D_0_w_0_address2 = tmp_133_1_fu_647_p1;
    end else begin
        Conv2D_0_w_0_address2 = 'bx;
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state12) | (1'b1 == ap_CS_fsm_state11) | (1'b1 == ap_CS_fsm_state10))) begin
        Conv2D_0_w_0_ce1 = 1'b1;
    end else begin
        Conv2D_0_w_0_ce1 = 1'b0;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state12) | (1'b1 == ap_CS_fsm_state10))) begin
        Conv2D_0_w_0_ce2 = 1'b1;
    end else begin
        Conv2D_0_w_0_ce2 = 1'b0;
    end
end

always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state13)) begin
        Padding2D_0_array_address0 = tmp_129_2_2_fu_846_p1;
    end else if ((1'b1 == ap_CS_fsm_state12)) begin
        Padding2D_0_array_address0 = tmp_129_2_fu_769_p1;
    end else if ((1'b1 == ap_CS_fsm_state11)) begin
        Padding2D_0_array_address0 = tmp_129_1_1_fu_673_p1;
    end else if ((1'b1 == ap_CS_fsm_state10)) begin
        Padding2D_0_array_address0 = tmp_129_0_2_fu_618_p1;
    end else if ((1'b1 == ap_CS_fsm_state9)) begin
        Padding2D_0_array_address0 = tmp_129_fu_577_p1;
    end else begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state12)) begin
        Padding2D_0_array_address1 = tmp_129_2_1_fu_783_p1;
    end else if ((1'b1 == ap_CS_fsm_state11)) begin
        Padding2D_0_array_address1 = tmp_129_1_2_fu_692_p1;
    end else if ((1'b1 == ap_CS_fsm_state10)) begin
        Padding2D_0_array_address1 = tmp_129_1_fu_637_p1;
    end else if ((1'b1 == ap_CS_fsm_state9)) begin
        Padding2D_0_array_address1 = tmp_129_0_1_fu_591_p1;
    end else begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state11) | (1'b1 == ap_CS_fsm_state17) | (1'b1 == ap_CS_fsm_state19) | (1'b1 == ap_CS_fsm_state7))) begin
        ...
        output_r_address0 = tmp_116_fu_493_p1;
    end else begin
...
assign Conv2D_0_b_address0 = tmp_112_fu_431_p1;

assign Conv2D_0_b_load_cast_fu_436_p0 = Conv2D_0_b_q0;

assign Conv2D_0_b_load_cast_fu_436_p1 = Conv2D_0_b_load_cast_fu_436_p0;
...
assign next_mul5_fu_410_p2 = (phi_mul4_reg_314 + tmp_108_reg_1077);

assign next_mul_fu_533_p2 = (tmp_106_reg_1065 + phi_mul_reg_359);
...
assign p_tmp_s_fu_960_p3 = ((tmp_67_fu_952_p3[0:0] === 1'b1) ? 15'd0 : tmp_117_cast_fu_947_p2);
...
assign tmp2_fu_807_p2 = (tmp_132_reg_1281 + output_r_q0);

assign tmp3_fu_465_p1 = tmp_105_reg_1060;
...
assign tmp4_fu_544_p2 = (tmp_113_reg_1123 + phi_mul_reg_359);

assign tmp5_1_fu_596_p0 = tmp_107_reg_1070;

assign tmp5_1_fu_596_p2 = ($signed({{1'b0}, {tmp5_1_fu_596_p0}}) * $signed(tmp4_1_reg_1205));

assign tmp5_2_fu_600_p0 = tmp_107_reg_1070;

assign tmp5_2_fu_600_p2 = ($signed({{1'b0}, {tmp5_2_fu_600_p0}}) * $signed(tmp4_2_reg_1210));

assign tmp5_fu_549_p0 = tmp_107_reg_1070;
...
assign tmp_105_fu_394_p1 = output_width;

assign tmp_106_fu_398_p1 = input_height;

assign tmp_107_fu_402_p1 = input_width;

assign tmp_108_fu_406_p1 = input_depth;

assign tmp_112_fu_431_p1 = out_d_reg_291;

assign tmp_113_fu_455_p1 = out_h_reg_326;

assign tmp_114_cast_fu_484_p1 = out_w_reg_337;

assign tmp_114_fu_480_p1 = out_w_reg_337;

assign tmp_115_fu_488_p2 = (tmp3_reg_1133 + tmp_114_fu_480_p1);

assign tmp_116_fu_493_p1 = $signed(tmp_115_fu_488_p2);

assign tmp_117_cast_fu_947_p2 = ($signed(tmp_66_fu_938_p1) + $signed(tmp_39_reg_1110));

assign tmp_117_fu_942_p2 = ($signed(Conv2D_0_b_load_cast_reg_1105) + $signed(output_r_q0));

assign tmp_119_fu_529_p1 = in_d_reg_348;

assign tmp_121_fu_538_p2 = (tmp_119_fu_529_p1 + phi_mul4_reg_314);

assign tmp_122_fu_568_p2 = (tmp_121_reg_1185 + tmp_68_fu_563_p2);
...
assign tmp_128_1_fu_633_p2 = (tmp_114_reg_1146 + tmp5_1_reg_1242);
...
assign tmp_128_2_fu_707_p2 = (tmp_114_reg_1146 + tmp5_2_reg_1249);

assign tmp_128_fu_573_p2 = (tmp_114_reg_1146 + tmp5_reg_1198);
...
assign tmp_129_fu_577_p1 = $signed(tmp_128_fu_573_p2);

assign tmp_130_fu_582_p1 = tmp_122_fu_568_p2;

assign tmp_132_0_1_fu_604_p2 = ($signed(32'd1) + $signed(tmp_122_reg_1215));

assign tmp_132_0_2_fu_623_p2 = ($signed(32'd2) + $signed(tmp_122_reg_1215));

assign tmp_132_1_1_fu_678_p2 = ($signed(32'd4) + $signed(tmp_122_reg_1215));

assign tmp_132_1_2_fu_697_p2 = ($signed(32'd5) + $signed(tmp_122_reg_1215));

assign tmp_132_1_fu_642_p2 = ($signed(32'd3) + $signed(tmp_122_reg_1215));

assign tmp_132_2_1_fu_787_p2 = ($signed(32'd7) + $signed(tmp_122_reg_1215));

assign tmp_132_2_2_fu_797_p2 = ($signed(32'd8) + $signed(tmp_122_reg_1215));

assign tmp_132_2_fu_773_p2 = ($signed(32'd6) + $signed(tmp_122_reg_1215));
...
assign tmp_39_fu_440_p0 = Conv2D_0_b_q0;

assign tmp_39_fu_440_p1 = tmp_39_fu_440_p0;

assign tmp_66_fu_938_p1 = output_r_q0[14:0];

assign tmp_67_fu_952_p3 = tmp_117_fu_942_p2[32'd15];

assign tmp_68_fu_563_p2 = tmp_121_reg_1185 << 32'd3;

assign tmp_fu_459_p2 = (phi_mul1_reg_302 + tmp_113_fu_455_p1);

assign tmp_s_fu_390_p1 = output_height;

always @ (posedge ap_clk) begin
    tmp_s_reg_1055[31:16] <= 16'b0000000000000000;
    tmp_105_reg_1060[31:16] <= 16'b0000000000000000;
    tmp_106_reg_1065[31:16] <= 16'b0000000000000000;
    tmp_107_reg_1070[31:16] <= 16'b0000000000000000;
    tmp_108_reg_1077[31:16] <= 16'b0000000000000000;
    tmp_113_reg_1123[31:16] <= 16'b0000000000000000;
    tmp_114_reg_1146[31:16] <= 16'b0000000000000000;
