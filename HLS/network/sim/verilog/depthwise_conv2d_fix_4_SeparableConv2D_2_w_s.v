// ==============================================================
// File generated on Sat Nov 02 18:31:48 JST 2019
...
// ==============================================================
`timescale 1 ns / 1 ps
(* rom_style = "distributed" *) module depthwise_conv2d_fix_4_SeparableConv2D_2_w_s_rom (
...
initial begin
    $readmemh("./depthwise_conv2d_fix_4_SeparableConv2D_2_w_s_rom.dat", ram0);
    $readmemh("./depthwise_conv2d_fix_4_SeparableConv2D_2_w_s_rom.dat", ram1);
    $readmemh("./depthwise_conv2d_fix_4_SeparableConv2D_2_w_s_rom.dat", ram2);
    $readmemh("./depthwise_conv2d_fix_4_SeparableConv2D_2_w_s_rom.dat", ram3);
    $readmemh("./depthwise_conv2d_fix_4_SeparableConv2D_2_w_s_rom.dat", ram4);
end
...
`timescale 1 ns / 1 ps
module depthwise_conv2d_fix_4_SeparableConv2D_2_w_s(
    reset,
    clk,
    address0,
    ce0,
...
depthwise_conv2d_fix_4_SeparableConv2D_2_w_s_rom depthwise_conv2d_fix_4_SeparableConv2D_2_w_s_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
