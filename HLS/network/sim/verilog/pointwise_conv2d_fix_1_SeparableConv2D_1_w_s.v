...
// ==============================================================
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module pointwise_conv2d_fix_1_SeparableConv2D_1_w_s_rom (
addr0, ce0, q0, addr1, ce1, q1, addr2, ce2, q2, addr3, ce3, q3, addr4, ce4, q4, addr5, ce5, q5, addr6, ce6, q6, addr7, ce7, q7, addr8, ce8, q8, addr9, ce9, q9, addr10, ce10, q10, addr11, ce11, q11, addr12, ce12, q12, addr13, ce13, q13, addr14, ce14, q14, clk);
...
initial begin
    $readmemh("./pointwise_conv2d_fix_1_SeparableConv2D_1_w_s_rom.dat", ram0);
    $readmemh("./pointwise_conv2d_fix_1_SeparableConv2D_1_w_s_rom.dat", ram1);
    $readmemh("./pointwise_conv2d_fix_1_SeparableConv2D_1_w_s_rom.dat", ram2);
    $readmemh("./pointwise_conv2d_fix_1_SeparableConv2D_1_w_s_rom.dat", ram3);
    $readmemh("./pointwise_conv2d_fix_1_SeparableConv2D_1_w_s_rom.dat", ram4);
    $readmemh("./pointwise_conv2d_fix_1_SeparableConv2D_1_w_s_rom.dat", ram5);
    $readmemh("./pointwise_conv2d_fix_1_SeparableConv2D_1_w_s_rom.dat", ram6);
    $readmemh("./pointwise_conv2d_fix_1_SeparableConv2D_1_w_s_rom.dat", ram7);
end
...
`timescale 1 ns / 1 ps
module pointwise_conv2d_fix_1_SeparableConv2D_1_w_s(
    reset,
    clk,
    address0,
    ce0,
...
pointwise_conv2d_fix_1_SeparableConv2D_1_w_s_rom pointwise_conv2d_fix_1_SeparableConv2D_1_w_s_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
