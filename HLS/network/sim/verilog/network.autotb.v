// ==============================================================
// File generated on Tue Dec 17 18:41:43 JST 2019
...
`define AUTOTB_TVIN_input_data_V_data_V_out_wrapc  "../tv/rtldatafile/rtl.network.autotvin_input_data_V_data_V.dat"
`define AUTOTB_TVIN_input_data_V_keep_V_out_wrapc  "../tv/rtldatafile/rtl.network.autotvin_input_data_V_keep_V.dat"
`define AUTOTB_TVIN_input_data_V_strb_V_out_wrapc  "../tv/rtldatafile/rtl.network.autotvin_input_data_V_strb_V.dat"
`define AUTOTB_TVIN_input_data_V_user_V_out_wrapc  "../tv/rtldatafile/rtl.network.autotvin_input_data_V_user_V.dat"
`define AUTOTB_TVIN_input_data_V_last_V_out_wrapc  "../tv/rtldatafile/rtl.network.autotvin_input_data_V_last_V.dat"
`define AUTOTB_TVIN_input_data_V_id_V_out_wrapc  "../tv/rtldatafile/rtl.network.autotvin_input_data_V_id_V.dat"
`define AUTOTB_TVIN_input_data_V_dest_V_out_wrapc  "../tv/rtldatafile/rtl.network.autotvin_input_data_V_dest_V.dat"
`define AUTOTB_TVIN_output_data_V_data_V_out_wrapc  "../tv/rtldatafile/rtl.network.autotvin_output_data_V_data_V.dat"
`define AUTOTB_TVIN_output_data_V_keep_V_out_wrapc  "../tv/rtldatafile/rtl.network.autotvin_output_data_V_keep_V.dat"
`define AUTOTB_TVIN_output_data_V_strb_V_out_wrapc  "../tv/rtldatafile/rtl.network.autotvin_output_data_V_strb_V.dat"
`define AUTOTB_TVIN_output_data_V_user_V_out_wrapc  "../tv/rtldatafile/rtl.network.autotvin_output_data_V_user_V.dat"
`define AUTOTB_TVIN_output_data_V_last_V_out_wrapc  "../tv/rtldatafile/rtl.network.autotvin_output_data_V_last_V.dat"
`define AUTOTB_TVIN_output_data_V_id_V_out_wrapc  "../tv/rtldatafile/rtl.network.autotvin_output_data_V_id_V.dat"
`define AUTOTB_TVIN_output_data_V_dest_V_out_wrapc  "../tv/rtldatafile/rtl.network.autotvin_output_data_V_dest_V.dat"
...
`define AUTOTB_TVOUT_output_data_V_user_V_out_wrapc  "../tv/rtldatafile/rtl.network.autotvout_output_data_V_user_V.dat"
...
parameter LATENCY_ESTIMATION = 1920361;
...
begin
    ...
    `define STREAM_SIZE_IN_input_data_V_data_V "../tv/stream_size/stream_size_in_input_data_V_data_V.dat"
