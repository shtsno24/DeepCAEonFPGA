// ==============================================================
// File generated on Mon Dec 23 18:16:06 JST 2019
...
`define AUTOTB_TVIN_input_data_data_V_out_wrapc  "../tv/rtldatafile/rtl.network.autotvin_input_data_data_V.dat"
`define AUTOTB_TVIN_input_data_keep_V_out_wrapc  "../tv/rtldatafile/rtl.network.autotvin_input_data_keep_V.dat"
`define AUTOTB_TVIN_input_data_strb_V_out_wrapc  "../tv/rtldatafile/rtl.network.autotvin_input_data_strb_V.dat"
`define AUTOTB_TVIN_input_data_user_V_out_wrapc  "../tv/rtldatafile/rtl.network.autotvin_input_data_user_V.dat"
`define AUTOTB_TVIN_input_data_last_V_out_wrapc  "../tv/rtldatafile/rtl.network.autotvin_input_data_last_V.dat"
`define AUTOTB_TVIN_input_data_id_V_out_wrapc  "../tv/rtldatafile/rtl.network.autotvin_input_data_id_V.dat"
`define AUTOTB_TVIN_input_data_dest_V_out_wrapc  "../tv/rtldatafile/rtl.network.autotvin_input_data_dest_V.dat"
`define AUTOTB_TVIN_output_data_data_V_out_wrapc  "../tv/rtldatafile/rtl.network.autotvin_output_data_data_V.dat"
`define AUTOTB_TVIN_output_data_keep_V_out_wrapc  "../tv/rtldatafile/rtl.network.autotvin_output_data_keep_V.dat"
`define AUTOTB_TVIN_output_data_strb_V_out_wrapc  "../tv/rtldatafile/rtl.network.autotvin_output_data_strb_V.dat"
`define AUTOTB_TVIN_output_data_user_V_out_wrapc  "../tv/rtldatafile/rtl.network.autotvin_output_data_user_V.dat"
`define AUTOTB_TVIN_output_data_last_V_out_wrapc  "../tv/rtldatafile/rtl.network.autotvin_output_data_last_V.dat"
`define AUTOTB_TVIN_output_data_id_V_out_wrapc  "../tv/rtldatafile/rtl.network.autotvin_output_data_id_V.dat"
`define AUTOTB_TVIN_output_data_dest_V_out_wrapc  "../tv/rtldatafile/rtl.network.autotvin_output_data_dest_V.dat"
...
`define AUTOTB_TVOUT_output_data_data_V_out_wrapc  "../tv/rtldatafile/rtl.network.autotvout_output_data_data_V.dat"
`define AUTOTB_TVOUT_output_data_keep_V_out_wrapc  "../tv/rtldatafile/rtl.network.autotvout_output_data_keep_V.dat"
`define AUTOTB_TVOUT_output_data_strb_V_out_wrapc  "../tv/rtldatafile/rtl.network.autotvout_output_data_strb_V.dat"
`define AUTOTB_TVOUT_output_data_user_V_out_wrapc  "../tv/rtldatafile/rtl.network.autotvout_output_data_user_V.dat"
`define AUTOTB_TVOUT_output_data_last_V_out_wrapc  "../tv/rtldatafile/rtl.network.autotvout_output_data_last_V.dat"
`define AUTOTB_TVOUT_output_data_id_V_out_wrapc  "../tv/rtldatafile/rtl.network.autotvout_output_data_id_V.dat"
`define AUTOTB_TVOUT_output_data_dest_V_out_wrapc  "../tv/rtldatafile/rtl.network.autotvout_output_data_dest_V.dat"
...
begin
    ...
    `define STREAM_SIZE_IN_input_data_data_V "../tv/stream_size/stream_size_in_input_data_data_V.dat"
