...
`define TV_IN_input_data_TDATA "./c.network.autotvin_input_data_data_V.dat"
`define TV_IN_input_data_TKEEP "./c.network.autotvin_input_data_keep_V.dat"
`define TV_IN_input_data_TSTRB "./c.network.autotvin_input_data_strb_V.dat"
`define TV_IN_input_data_TUSER "./c.network.autotvin_input_data_user_V.dat"
`define TV_IN_input_data_TLAST "./c.network.autotvin_input_data_last_V.dat"
`define TV_IN_input_data_TID "./c.network.autotvin_input_data_id_V.dat"
`define TV_IN_input_data_TDEST "./c.network.autotvin_input_data_dest_V.dat"
