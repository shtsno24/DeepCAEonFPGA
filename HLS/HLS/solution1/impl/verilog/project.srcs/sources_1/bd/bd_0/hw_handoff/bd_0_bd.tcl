...
proc create_root_design { parentCell } {
  ...
  set hls_inst [ create_bd_cell -type ip -vlnv xilinx.com:hls:network:1.0 hls_inst ]

  # Create interface connections
  connect_bd_intf_net -intf_net hls_inst_output_data [get_bd_intf_ports output_data] [get_bd_intf_pins hls_inst/output_data]
  connect_bd_intf_net -intf_net input_data_0_1 [get_bd_intf_ports input_data] [get_bd_intf_pins hls_inst/input_data]
  connect_bd_intf_net -intf_net s_axi_AXILiteS_0_1 [get_bd_intf_ports s_axi_AXILiteS] [get_bd_intf_pins hls_inst/s_axi_AXILiteS]
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0x00000000 [get_bd_addr_spaces s_axi_AXILiteS] [get_bd_addr_segs hls_inst/s_axi_AXILiteS/Reg] SEG_hls_inst_Reg
