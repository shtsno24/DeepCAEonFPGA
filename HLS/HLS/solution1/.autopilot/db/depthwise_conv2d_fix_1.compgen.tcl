...
set id 87
set name network_mac_muladd_5ns_7ns_4ns_11_1_1
...
set out_width 11
set exp i0*i1+i2
set arg_lists {i0 {5 0 +} i1 {7 0 +} m {11 0 +} i2 {4 0 +} p {11 0 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename bias \
    op interface \
    ports { bias_address0 { O 3 vector } bias_ce0 { O 1 bit } bias_q0 { I 16 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename kernel \
    op interface \
    ports { kernel_address0 { O 5 vector } kernel_ce0 { O 1 bit } kernel_q0 { I 16 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename kernel1 \
    op interface \
    ports { kernel1_address0 { O 5 vector } kernel1_ce0 { O 1 bit } kernel1_q0 { I 16 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'kernel1'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename kernel2 \
    op interface \
    ports { kernel2_address0 { O 5 vector } kernel2_ce0 { O 1 bit } kernel2_q0 { I 16 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'kernel2'"
}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { output_height { I 5 vector } } \
} "
}
