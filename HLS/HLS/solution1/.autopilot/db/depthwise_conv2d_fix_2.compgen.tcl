...
set id 41
set name network_mux_32_16_3_1_x
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename kernel \
    op interface \
    ports { kernel_address0 { O 6 vector } kernel_ce0 { O 1 bit } kernel_q0 { I 16 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename kernel1 \
    op interface \
    ports { kernel1_address0 { O 6 vector } kernel1_ce0 { O 1 bit } kernel1_q0 { I 16 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename kernel2 \
    op interface \
    ports { kernel2_address0 { O 6 vector } kernel2_ce0 { O 1 bit } kernel2_q0 { I 16 vector } } \
} "
} else {
