...
set id 24
set name network_mul_mul_16s_16s_32_1_1
...
set ID 26
set hasByteEnable 0
set MemName depthwise_conv2d_fix_2_empty
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename kernel_0 \
    op interface \
    ports { kernel_0_address0 { O 8 vector } kernel_0_ce0 { O 1 bit } kernel_0_q0 { I 16 vector } } \
} "
} else {
