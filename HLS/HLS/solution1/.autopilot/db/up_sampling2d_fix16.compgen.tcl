...
set id 1069
set name network_urem_21ns_11ns_21_25_seq_1
...
set id 1070
set name network_urem_19ns_11ns_19_23_seq_1
set corename simcore_urem_seq
set op urem
set stage_num 23
set max_latency -1
...
set id 1216
set name network_am_addmul_15ns_9ns_5ns_19_1_1
...
set out_width 19
set exp (i0+i1)*i2
set arg_lists {i0 {15 0 +} i1 {9 0 +} s {16 0 +} i2 {5 0 +} p {19 0 +} c_expval {c} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
...
set id 1217
set name network_am_addmul_16ns_10ns_6ns_21_1_1
set corename simcore_am
set op am
set stage_num 1
set max_latency -1
...
set out_width 21
set exp (i0+i1)*i2
set arg_lists {i0 {16 0 +} i1 {10 0 +} s {17 0 +} i2 {6 0 +} p {21 0 +} c_expval {c} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_am] == "ap_gen_simcore_am"} {
eval "ap_gen_simcore_am { \
